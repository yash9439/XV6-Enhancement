...
void forktest(void)
{
  ...
  3e:	43e50513          	addi	a0,a0,1086 # 478 <setpriority+0xc>
  ...
  68:	42450513          	addi	a0,a0,1060 # 488 <setpriority+0x1c>
  ...
  b8:	42450513          	addi	a0,a0,1060 # 4d8 <setpriority+0x6c>
  ...
  d4:	3d850513          	addi	a0,a0,984 # 4a8 <setpriority+0x3c>
  ...
  ee:	3d650513          	addi	a0,a0,982 # 4c0 <setpriority+0x54>
