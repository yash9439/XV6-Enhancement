...
00000000000000ac <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      be:	02e50513          	addi	a0,a0,46 # 60e8 <malloc+0x122>
  ...
  fd = open("doesnotexist", 0);
      ...
      dc:	03050513          	addi	a0,a0,48 # 6108 <malloc+0x142>
  ...
  if (fd >= 0)
    ...
    printf("%s: open echo failed!\n", s);
      ...
      fc:	ff850513          	addi	a0,a0,-8 # 60f0 <malloc+0x12a>
     100:	00006097          	auipc	ra,0x6
     104:	e0e080e7          	jalr	-498(ra) # 5f0e <printf>
    exit(1);
     108:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     118:	00450513          	addi	a0,a0,4 # 6118 <malloc+0x152>
     11c:	00006097          	auipc	ra,0x6
     120:	df2080e7          	jalr	-526(ra) # 5f0e <printf>
    exit(1);
     124:	4505                	li	a0,1
...
000000000000012e <truncate2>:
{
  ...
  int n = write(fd1, "x", 1);
     ...
     192:	fca58593          	addi	a1,a1,-54 # 6158 <malloc+0x192>
     196:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     1aa:	f9a50513          	addi	a0,a0,-102 # 6140 <malloc+0x17a>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1e0:	f8450513          	addi	a0,a0,-124 # 6160 <malloc+0x19a>
     1e4:	00006097          	auipc	ra,0x6
     1e8:	d2a080e7          	jalr	-726(ra) # 5f0e <printf>
    exit(1);
     1ec:	4505                	li	a0,1
...
0000000000000276 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     292:	efa50513          	addi	a0,a0,-262 # 6188 <malloc+0x1c2>
  ...
  for (sz = 499; sz < (MAXOPBLOCKS + 2) * BSIZE; sz += 471)
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     2a6:	ee6a8a93          	addi	s5,s5,-282 # 6188 <malloc+0x1c2>
  ...
  for (sz = 499; sz < (MAXOPBLOCKS + 2) * BSIZE; sz += 471)
     ...
     328:	e7450513          	addi	a0,a0,-396 # 6198 <malloc+0x1d2>
     32c:	00006097          	auipc	ra,0x6
     330:	be2080e7          	jalr	-1054(ra) # 5f0e <printf>
      exit(1);
     334:	4505                	li	a0,1
     ...
     34a:	e7250513          	addi	a0,a0,-398 # 61b8 <malloc+0x1f2>
     34e:	00006097          	auipc	ra,0x6
     352:	bc0080e7          	jalr	-1088(ra) # 5f0e <printf>
        exit(1);
     356:	4505                	li	a0,1
...
void badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     374:	e6050513          	addi	a0,a0,-416 # 61d0 <malloc+0x20a>
  ...
  for (int i = 0; i < assumed_free; i++)
  {
    int fd = open("junk", O_CREATE | O_WRONLY);
     ...
     388:	e4c98993          	addi	s3,s3,-436 # 61d0 <malloc+0x20a>
    if (fd < 0)
    {
  ...
  int fd = open("junk", O_CREATE | O_WRONLY);
     ...
     3d4:	e0050513          	addi	a0,a0,-512 # 61d0 <malloc+0x20a>
  ...
  if (write(fd, "x", 1) != 1)
     ...
     3ec:	d7058593          	addi	a1,a1,-656 # 6158 <malloc+0x192>
     ...
     3fa:	04f50963          	beq	a0,a5,44c <badwrite+0xec>
  {
    printf("write failed\n");
     ...
     402:	df250513          	addi	a0,a0,-526 # 61f0 <malloc+0x22a>
     406:	00006097          	auipc	ra,0x6
     40a:	b08080e7          	jalr	-1272(ra) # 5f0e <printf>
    exit(1);
     40e:	4505                	li	a0,1
     ...
     41c:	dc050513          	addi	a0,a0,-576 # 61d8 <malloc+0x212>
     420:	00006097          	auipc	ra,0x6
     424:	aee080e7          	jalr	-1298(ra) # 5f0e <printf>
      exit(1);
     428:	4505                	li	a0,1
    ...
    printf("open junk failed\n");
     ...
     436:	da650513          	addi	a0,a0,-602 # 61d8 <malloc+0x212>
     43a:	00006097          	auipc	ra,0x6
     43e:	ad4080e7          	jalr	-1324(ra) # 5f0e <printf>
    exit(1);
     442:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     45a:	d7a50513          	addi	a0,a0,-646 # 61d0 <malloc+0x20a>
...
0000000000000540 <copyin>:
{
  ...
  for (int ai = 0; ai < 2; ai++)
    ...
    int fd = open("copyin1", O_CREATE | O_WRONLY);
     ...
     566:	c9ea0a13          	addi	s4,s4,-866 # 6200 <malloc+0x23a>
    uint64 addr = addrs[ai];
  ...
  for (int ai = 0; ai < 2; ai++)
     ...
     612:	bfa50513          	addi	a0,a0,-1030 # 6208 <malloc+0x242>
     616:	00006097          	auipc	ra,0x6
     61a:	8f8080e7          	jalr	-1800(ra) # 5f0e <printf>
      exit(1);
     61e:	4505                	li	a0,1
     ...
     630:	bf450513          	addi	a0,a0,-1036 # 6220 <malloc+0x25a>
     634:	00006097          	auipc	ra,0x6
     638:	8da080e7          	jalr	-1830(ra) # 5f0e <printf>
      exit(1);
     63c:	4505                	li	a0,1
     ...
     64e:	c0650513          	addi	a0,a0,-1018 # 6250 <malloc+0x28a>
     652:	00006097          	auipc	ra,0x6
     656:	8bc080e7          	jalr	-1860(ra) # 5f0e <printf>
      exit(1);
     65a:	4505                	li	a0,1
     ...
     668:	c1c50513          	addi	a0,a0,-996 # 6280 <malloc+0x2ba>
     66c:	00006097          	auipc	ra,0x6
     670:	8a2080e7          	jalr	-1886(ra) # 5f0e <printf>
      exit(1);
     674:	4505                	li	a0,1
     ...
     686:	c0e50513          	addi	a0,a0,-1010 # 6290 <malloc+0x2ca>
     68a:	00006097          	auipc	ra,0x6
     68e:	884080e7          	jalr	-1916(ra) # 5f0e <printf>
      exit(1);
     692:	4505                	li	a0,1
...
000000000000069c <copyout>:
{
  ...
  for (int ai = 0; ai < 2; ai++)
    ...
    int fd = open("README", 0);
     ...
     6c4:	c00a0a13          	addi	s4,s4,-1024 # 62c0 <malloc+0x2fa>
    n = write(fds[1], "x", 1);
     6c8:	00006a97          	auipc	s5,0x6
     6cc:	a90a8a93          	addi	s5,s5,-1392 # 6158 <malloc+0x192>
    uint64 addr = addrs[ai];
  ...
  for (int ai = 0; ai < 2; ai++)
     ...
     772:	b5a50513          	addi	a0,a0,-1190 # 62c8 <malloc+0x302>
     776:	00005097          	auipc	ra,0x5
     77a:	798080e7          	jalr	1944(ra) # 5f0e <printf>
      exit(1);
     77e:	4505                	li	a0,1
     ...
     790:	b5450513          	addi	a0,a0,-1196 # 62e0 <malloc+0x31a>
     794:	00005097          	auipc	ra,0x5
     798:	77a080e7          	jalr	1914(ra) # 5f0e <printf>
      exit(1);
     79c:	4505                	li	a0,1
     ...
     7aa:	ada50513          	addi	a0,a0,-1318 # 6280 <malloc+0x2ba>
     7ae:	00005097          	auipc	ra,0x5
     7b2:	760080e7          	jalr	1888(ra) # 5f0e <printf>
      exit(1);
     7b6:	4505                	li	a0,1
     ...
     7c4:	b5050513          	addi	a0,a0,-1200 # 6310 <malloc+0x34a>
     7c8:	00005097          	auipc	ra,0x5
     7cc:	746080e7          	jalr	1862(ra) # 5f0e <printf>
      exit(1);
     7d0:	4505                	li	a0,1
     ...
     7e2:	b4a50513          	addi	a0,a0,-1206 # 6328 <malloc+0x362>
     7e6:	00005097          	auipc	ra,0x5
     7ea:	728080e7          	jalr	1832(ra) # 5f0e <printf>
      exit(1);
     7ee:	4505                	li	a0,1
...
00000000000007f8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     838:	91c58593          	addi	a1,a1,-1764 # 6150 <malloc+0x18a>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     854:	8f050513          	addi	a0,a0,-1808 # 6140 <malloc+0x17a>
  ...
  fd1 = open("truncfile", O_WRONLY | O_TRUNC);
     ...
     880:	8c450513          	addi	a0,a0,-1852 # 6140 <malloc+0x17a>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     894:	8b050513          	addi	a0,a0,-1872 # 6140 <malloc+0x17a>
  ...
  write(fd1, "abcdef", 6);
     ...
     8d2:	aea58593          	addi	a1,a1,-1302 # 63b8 <malloc+0x3f2>
     8d6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     914:	83050513          	addi	a0,a0,-2000 # 6140 <malloc+0x17a>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     958:	a0450513          	addi	a0,a0,-1532 # 6358 <malloc+0x392>
     95c:	00005097          	auipc	ra,0x5
     960:	5b2080e7          	jalr	1458(ra) # 5f0e <printf>
    exit(1);
     964:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     974:	a0850513          	addi	a0,a0,-1528 # 6378 <malloc+0x3b2>
     978:	00005097          	auipc	ra,0x5
     97c:	596080e7          	jalr	1430(ra) # 5f0e <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     980:	8652                	mv	a2,s4
     982:	85d6                	mv	a1,s5
     984:	00006517          	auipc	a0,0x6
     988:	a0450513          	addi	a0,a0,-1532 # 6388 <malloc+0x3c2>
     98c:	00005097          	auipc	ra,0x5
     990:	582080e7          	jalr	1410(ra) # 5f0e <printf>
    exit(1);
     994:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     9a4:	a0850513          	addi	a0,a0,-1528 # 63a8 <malloc+0x3e2>
     9a8:	00005097          	auipc	ra,0x5
     9ac:	566080e7          	jalr	1382(ra) # 5f0e <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     9b0:	8652                	mv	a2,s4
     9b2:	85d6                	mv	a1,s5
     9b4:	00006517          	auipc	a0,0x6
     9b8:	9d450513          	addi	a0,a0,-1580 # 6388 <malloc+0x3c2>
     9bc:	00005097          	auipc	ra,0x5
     9c0:	552080e7          	jalr	1362(ra) # 5f0e <printf>
    exit(1);
     9c4:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9d6:	9ee50513          	addi	a0,a0,-1554 # 63c0 <malloc+0x3fa>
     9da:	00005097          	auipc	ra,0x5
     9de:	534080e7          	jalr	1332(ra) # 5f0e <printf>
    exit(1);
     9e2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9f4:	9f050513          	addi	a0,a0,-1552 # 63e0 <malloc+0x41a>
     9f8:	00005097          	auipc	ra,0x5
     9fc:	516080e7          	jalr	1302(ra) # 5f0e <printf>
    exit(1);
     a00:	4505                	li	a0,1
...
0000000000000a0a <writetest>:
{
  ...
  fd = open("small", O_CREATE | O_RDWR);
     ...
     a28:	9dc50513          	addi	a0,a0,-1572 # 6400 <malloc+0x43a>
  ...
  if (fd < 0)
    ...
    if (write(fd, "aaaaaaaaaa", SZ) != SZ)
     ...
     a40:	9ec98993          	addi	s3,s3,-1556 # 6428 <malloc+0x462>
    if (write(fd, "bbbbbbbbbb", SZ) != SZ)
     a44:	00006a97          	auipc	s5,0x6
     a48:	a1ca8a93          	addi	s5,s5,-1508 # 6460 <malloc+0x49a>
  for (i = 0; i < N; i++)
  ...
  fd = open("small", O_RDONLY);
     ...
     a8e:	97650513          	addi	a0,a0,-1674 # 6400 <malloc+0x43a>
  ...
  if (unlink("small") < 0)
     ...
     aca:	93a50513          	addi	a0,a0,-1734 # 6400 <malloc+0x43a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     af4:	91850513          	addi	a0,a0,-1768 # 6408 <malloc+0x442>
     af8:	00005097          	auipc	ra,0x5
     afc:	416080e7          	jalr	1046(ra) # 5f0e <printf>
    exit(1);
     b00:	4505                	li	a0,1
     ...
     b12:	92a50513          	addi	a0,a0,-1750 # 6438 <malloc+0x472>
     b16:	00005097          	auipc	ra,0x5
     b1a:	3f8080e7          	jalr	1016(ra) # 5f0e <printf>
      exit(1);
     b1e:	4505                	li	a0,1
     ...
     b30:	94450513          	addi	a0,a0,-1724 # 6470 <malloc+0x4aa>
     b34:	00005097          	auipc	ra,0x5
     b38:	3da080e7          	jalr	986(ra) # 5f0e <printf>
      exit(1);
     b3c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b4c:	95050513          	addi	a0,a0,-1712 # 6498 <malloc+0x4d2>
     b50:	00005097          	auipc	ra,0x5
     b54:	3be080e7          	jalr	958(ra) # 5f0e <printf>
    exit(1);
     b58:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     b68:	95450513          	addi	a0,a0,-1708 # 64b8 <malloc+0x4f2>
     b6c:	00005097          	auipc	ra,0x5
     b70:	3a2080e7          	jalr	930(ra) # 5f0e <printf>
    exit(1);
     b74:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b84:	95050513          	addi	a0,a0,-1712 # 64d0 <malloc+0x50a>
     b88:	00005097          	auipc	ra,0x5
     b8c:	386080e7          	jalr	902(ra) # 5f0e <printf>
    exit(1);
     b90:	4505                	li	a0,1
...
0000000000000b9a <writebig>:
{
  ...
  fd = open("big", O_CREATE | O_RDWR);
     ...
     bb6:	93e50513          	addi	a0,a0,-1730 # 64f0 <malloc+0x52a>
  ...
  fd = open("big", O_RDONLY);
     ...
     c08:	8ec50513          	addi	a0,a0,-1812 # 64f0 <malloc+0x52a>
  ...
  if (fd < 0)
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c50:	8ac50513          	addi	a0,a0,-1876 # 64f8 <malloc+0x532>
     c54:	00005097          	auipc	ra,0x5
     c58:	2ba080e7          	jalr	698(ra) # 5f0e <printf>
    exit(1);
     c5c:	4505                	li	a0,1
     ...
     c6e:	8ae50513          	addi	a0,a0,-1874 # 6518 <malloc+0x552>
     c72:	00005097          	auipc	ra,0x5
     c76:	29c080e7          	jalr	668(ra) # 5f0e <printf>
      exit(1);
     c7a:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c8a:	8ba50513          	addi	a0,a0,-1862 # 6540 <malloc+0x57a>
     c8e:	00005097          	auipc	ra,0x5
     c92:	280080e7          	jalr	640(ra) # 5f0e <printf>
    exit(1);
     c96:	4505                	li	a0,1
  ...
  if (unlink("big") < 0)
     ...
     cb6:	83e50513          	addi	a0,a0,-1986 # 64f0 <malloc+0x52a>
     ...
     ce2:	88250513          	addi	a0,a0,-1918 # 6560 <malloc+0x59a>
     ce6:	00005097          	auipc	ra,0x5
     cea:	228080e7          	jalr	552(ra) # 5f0e <printf>
        exit(1);
     cee:	4505                	li	a0,1
     ...
     d00:	88c50513          	addi	a0,a0,-1908 # 6588 <malloc+0x5c2>
     d04:	00005097          	auipc	ra,0x5
     d08:	20a080e7          	jalr	522(ra) # 5f0e <printf>
      exit(1);
     d0c:	4505                	li	a0,1
     ...
     d1e:	88650513          	addi	a0,a0,-1914 # 65a0 <malloc+0x5da>
     d22:	00005097          	auipc	ra,0x5
     d26:	1ec080e7          	jalr	492(ra) # 5f0e <printf>
      exit(1);
     d2a:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d3a:	89250513          	addi	a0,a0,-1902 # 65c8 <malloc+0x602>
     d3e:	00005097          	auipc	ra,0x5
     d42:	1d0080e7          	jalr	464(ra) # 5f0e <printf>
    exit(1);
     d46:	4505                	li	a0,1
...
0000000000000d50 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d68:	87c50513          	addi	a0,a0,-1924 # 65e0 <malloc+0x61a>
  ...
  write(fd, "hello", SZ);
     ...
     d80:	89458593          	addi	a1,a1,-1900 # 6610 <malloc+0x64a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d9c:	84850513          	addi	a0,a0,-1976 # 65e0 <malloc+0x61a>
  ...
  if (unlink("unlinkread") != 0)
     ...
     db2:	83250513          	addi	a0,a0,-1998 # 65e0 <malloc+0x61a>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     dc8:	81c50513          	addi	a0,a0,-2020 # 65e0 <malloc+0x61a>
  ...
  write(fd1, "yyy", 3);
     ...
     ddc:	88058593          	addi	a1,a1,-1920 # 6658 <malloc+0x692>
  ...
  unlink("unlinkread");
     ...
     e44:	7a050513          	addi	a0,a0,1952 # 65e0 <malloc+0x61a>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e64:	79050513          	addi	a0,a0,1936 # 65f0 <malloc+0x62a>
     e68:	00005097          	auipc	ra,0x5
     e6c:	0a6080e7          	jalr	166(ra) # 5f0e <printf>
    exit(1);
     e70:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e80:	79c50513          	addi	a0,a0,1948 # 6618 <malloc+0x652>
     e84:	00005097          	auipc	ra,0x5
     e88:	08a080e7          	jalr	138(ra) # 5f0e <printf>
    exit(1);
     e8c:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e9c:	7a050513          	addi	a0,a0,1952 # 6638 <malloc+0x672>
     ea0:	00005097          	auipc	ra,0x5
     ea4:	06e080e7          	jalr	110(ra) # 5f0e <printf>
    exit(1);
     ea8:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     eb8:	7ac50513          	addi	a0,a0,1964 # 6660 <malloc+0x69a>
     ebc:	00005097          	auipc	ra,0x5
     ec0:	052080e7          	jalr	82(ra) # 5f0e <printf>
    exit(1);
     ec4:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ed4:	7b050513          	addi	a0,a0,1968 # 6680 <malloc+0x6ba>
     ed8:	00005097          	auipc	ra,0x5
     edc:	036080e7          	jalr	54(ra) # 5f0e <printf>
    exit(1);
     ee0:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ef0:	7b450513          	addi	a0,a0,1972 # 66a0 <malloc+0x6da>
     ef4:	00005097          	auipc	ra,0x5
     ef8:	01a080e7          	jalr	26(ra) # 5f0e <printf>
    exit(1);
     efc:	4505                	li	a0,1
...
0000000000000f06 <linktest>:
{
  ...
  if (write(fd, "hello", SZ) != SZ)
     ...
     f54:	6c058593          	addi	a1,a1,1728 # 6610 <malloc+0x64a>
  ...
  if (link("lf1", "lf2") < 0)
     ...
     f74:	75858593          	addi	a1,a1,1880 # 66c8 <malloc+0x702>
     f78:	00005517          	auipc	a0,0x5
     f7c:	74850513          	addi	a0,a0,1864 # 66c0 <malloc+0x6fa>
  ...
  if (open("lf1", 0) >= 0)
     ...
     fa2:	72250513          	addi	a0,a0,1826 # 66c0 <malloc+0x6fa>
  ...
  fd = open("lf2", 0);
     ...
     fb8:	71450513          	addi	a0,a0,1812 # 66c8 <malloc+0x702>
  ...
  if (link("lf2", "lf2") >= 0)
     ...
     ff0:	6dc58593          	addi	a1,a1,1756 # 66c8 <malloc+0x702>
     ff4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
    ...
    1006:	6c650513          	addi	a0,a0,1734 # 66c8 <malloc+0x702>
    100a:	00005097          	auipc	ra,0x5
    100e:	baa080e7          	jalr	-1110(ra) # 5bb4 <unlink>
  if (link("lf2", "lf1") >= 0)
    1012:	00005597          	auipc	a1,0x5
    1016:	6ae58593          	addi	a1,a1,1710 # 66c0 <malloc+0x6fa>
    101a:	00005517          	auipc	a0,0x5
    101e:	6ae50513          	addi	a0,a0,1710 # 66c8 <malloc+0x702>
  ...
  if (link(".", "lf1") >= 0)
    ...
    1032:	69258593          	addi	a1,a1,1682 # 66c0 <malloc+0x6fa>
    1036:	00005517          	auipc	a0,0x5
    103a:	79a50513          	addi	a0,a0,1946 # 67d0 <malloc+0x80a>
    ...
    105c:	67850513          	addi	a0,a0,1656 # 66d0 <malloc+0x70a>
    1060:	00005097          	auipc	ra,0x5
    1064:	eae080e7          	jalr	-338(ra) # 5f0e <printf>
    exit(1);
    1068:	4505                	li	a0,1
    ...
    1078:	67450513          	addi	a0,a0,1652 # 66e8 <malloc+0x722>
    107c:	00005097          	auipc	ra,0x5
    1080:	e92080e7          	jalr	-366(ra) # 5f0e <printf>
    exit(1);
    1084:	4505                	li	a0,1
    ...
    1094:	67050513          	addi	a0,a0,1648 # 6700 <malloc+0x73a>
    1098:	00005097          	auipc	ra,0x5
    109c:	e76080e7          	jalr	-394(ra) # 5f0e <printf>
    exit(1);
    10a0:	4505                	li	a0,1
    ...
    10b0:	67450513          	addi	a0,a0,1652 # 6720 <malloc+0x75a>
    10b4:	00005097          	auipc	ra,0x5
    10b8:	e5a080e7          	jalr	-422(ra) # 5f0e <printf>
    exit(1);
    10bc:	4505                	li	a0,1
    ...
    10cc:	68850513          	addi	a0,a0,1672 # 6750 <malloc+0x78a>
    10d0:	00005097          	auipc	ra,0x5
    10d4:	e3e080e7          	jalr	-450(ra) # 5f0e <printf>
    exit(1);
    10d8:	4505                	li	a0,1
    ...
    10e8:	68450513          	addi	a0,a0,1668 # 6768 <malloc+0x7a2>
    10ec:	00005097          	auipc	ra,0x5
    10f0:	e22080e7          	jalr	-478(ra) # 5f0e <printf>
    exit(1);
    10f4:	4505                	li	a0,1
    ...
    1104:	68050513          	addi	a0,a0,1664 # 6780 <malloc+0x7ba>
    1108:	00005097          	auipc	ra,0x5
    110c:	e06080e7          	jalr	-506(ra) # 5f0e <printf>
    exit(1);
    1110:	4505                	li	a0,1
    ...
    1120:	68c50513          	addi	a0,a0,1676 # 67a8 <malloc+0x7e2>
    1124:	00005097          	auipc	ra,0x5
    1128:	dea080e7          	jalr	-534(ra) # 5f0e <printf>
    exit(1);
    112c:	4505                	li	a0,1
    ...
    113c:	6a050513          	addi	a0,a0,1696 # 67d8 <malloc+0x812>
    1140:	00005097          	auipc	ra,0x5
    1144:	dce080e7          	jalr	-562(ra) # 5f0e <printf>
    exit(1);
    1148:	4505                	li	a0,1
...
0000000000001152 <validatetest>:
{
  ...
  for (p = 0; p <= (uint)hi; p += PGSIZE)
    ...
    116e:	68e98993          	addi	s3,s3,1678 # 67f8 <malloc+0x832>
    1172:	597d                	li	s2,-1
  for (p = 0; p <= (uint)hi; p += PGSIZE)
  ...
  for (p = 0; p <= (uint)hi; p += PGSIZE)
    ...
    11aa:	66250513          	addi	a0,a0,1634 # 6808 <malloc+0x842>
    11ae:	00005097          	auipc	ra,0x5
    11b2:	d60080e7          	jalr	-672(ra) # 5f0e <printf>
      exit(1);
    11b6:	4505                	li	a0,1
...
00000000000011c0 <bigdir>:
{
  ...
  for (i = 0; i < N; i++)
    ...
    1210:	61ca0a13          	addi	s4,s4,1564 # 6828 <malloc+0x862>
  for (i = 0; i < N; i++)
  ...
  unlink("bd");
    ...
    1262:	5ca50513          	addi	a0,a0,1482 # 6828 <malloc+0x862>
  ...
  for (i = 0; i < N; i++)
    ...
    12d2:	56250513          	addi	a0,a0,1378 # 6830 <malloc+0x86a>
    12d6:	00005097          	auipc	ra,0x5
    12da:	c38080e7          	jalr	-968(ra) # 5f0e <printf>
    exit(1);
    12de:	4505                	li	a0,1
    ...
    12f2:	56250513          	addi	a0,a0,1378 # 6850 <malloc+0x88a>
    12f6:	00005097          	auipc	ra,0x5
    12fa:	c18080e7          	jalr	-1000(ra) # 5f0e <printf>
      exit(1);
    12fe:	4505                	li	a0,1
    ...
    130e:	56650513          	addi	a0,a0,1382 # 6870 <malloc+0x8aa>
    1312:	00005097          	auipc	ra,0x5
    1316:	bfc080e7          	jalr	-1028(ra) # 5f0e <printf>
      exit(1);
    131a:	4505                	li	a0,1
...
000000000000135c <badarg>:
{
    ...
    137a:	d7298993          	addi	s3,s3,-654 # 60e8 <malloc+0x122>
    argv[0] = (char *)0xffffffff;
...
00000000000013a2 <copyinstr2>:
{
  ...
  char *args[] = {"xx", 0};
    ...
    1404:	6c878793          	addi	a5,a5,1736 # 7ac8 <malloc+0x1b02>
  ...
  if (pid == 0)
    ...
    1460:	0ac78793          	addi	a5,a5,172 # 8508 <malloc+0x2542>
    ...
    1484:	c6850513          	addi	a0,a0,-920 # 60e8 <malloc+0x122>
    ...
    149c:	48050513          	addi	a0,a0,1152 # 6918 <malloc+0x952>
    14a0:	00005097          	auipc	ra,0x5
    14a4:	a6e080e7          	jalr	-1426(ra) # 5f0e <printf>
      exit(1);
    14a8:	4505                	li	a0,1
    ...
    14bc:	3d850513          	addi	a0,a0,984 # 6890 <malloc+0x8ca>
    14c0:	00005097          	auipc	ra,0x5
    14c4:	a4e080e7          	jalr	-1458(ra) # 5f0e <printf>
    exit(1);
    14c8:	4505                	li	a0,1
    ...
    14dc:	3d850513          	addi	a0,a0,984 # 68b0 <malloc+0x8ea>
    14e0:	00005097          	auipc	ra,0x5
    14e4:	a2e080e7          	jalr	-1490(ra) # 5f0e <printf>
    exit(1);
    14e8:	4505                	li	a0,1
    ...
    14fe:	3d650513          	addi	a0,a0,982 # 68d0 <malloc+0x90a>
    1502:	00005097          	auipc	ra,0x5
    1506:	a0c080e7          	jalr	-1524(ra) # 5f0e <printf>
    exit(1);
    150a:	4505                	li	a0,1
    ...
    151e:	3de50513          	addi	a0,a0,990 # 68f8 <malloc+0x932>
    1522:	00005097          	auipc	ra,0x5
    1526:	9ec080e7          	jalr	-1556(ra) # 5f0e <printf>
    exit(1);
    152a:	4505                	li	a0,1
    ...
    1538:	84450513          	addi	a0,a0,-1980 # 6d78 <malloc+0xdb2>
    153c:	00005097          	auipc	ra,0x5
    1540:	9d2080e7          	jalr	-1582(ra) # 5f0e <printf>
    exit(1);
    1544:	4505                	li	a0,1
  ...
  if (st != 747)
    ...
    1582:	3c250513          	addi	a0,a0,962 # 6940 <malloc+0x97a>
    1586:	00005097          	auipc	ra,0x5
    158a:	988080e7          	jalr	-1656(ra) # 5f0e <printf>
    exit(1);
    158e:	4505                	li	a0,1
...
0000000000001598 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE | O_TRUNC | O_WRONLY));
    ...
    15b4:	b9050513          	addi	a0,a0,-1136 # 6140 <malloc+0x17a>
  ...
  if (pid == 0)
    ...
    15de:	b66a0a13          	addi	s4,s4,-1178 # 6140 <malloc+0x17a>
      int n = write(fd, "1234567890", 10);
    15e2:	00005a97          	auipc	s5,0x5
    15e6:	3bea8a93          	addi	s5,s5,958 # 69a0 <malloc+0x9da>
      int fd = open("truncfile", O_WRONLY);
    15ea:	4585                	li	a1,1
    15ec:	8552                	mv	a0,s4
    ...
    1656:	31e50513          	addi	a0,a0,798 # 6970 <malloc+0x9aa>
    165a:	00005097          	auipc	ra,0x5
    165e:	8b4080e7          	jalr	-1868(ra) # 5f0e <printf>
    exit(1);
    1662:	4505                	li	a0,1
    ...
    1672:	31a50513          	addi	a0,a0,794 # 6988 <malloc+0x9c2>
    1676:	00005097          	auipc	ra,0x5
    167a:	898080e7          	jalr	-1896(ra) # 5f0e <printf>
        exit(1);
    167e:	4505                	li	a0,1
    ...
    1690:	32450513          	addi	a0,a0,804 # 69b0 <malloc+0x9ea>
    1694:	00005097          	auipc	ra,0x5
    1698:	87a080e7          	jalr	-1926(ra) # 5f0e <printf>
        exit(1);
    169c:	4505                	li	a0,1
    ...
    16ae:	a96a0a13          	addi	s4,s4,-1386 # 6140 <malloc+0x17a>
    int n = write(fd, "xxx", 3);
    16b2:	00005a97          	auipc	s5,0x5
    16b6:	31ea8a93          	addi	s5,s5,798 # 69d0 <malloc+0xa0a>
    int fd = open("truncfile", O_CREATE | O_WRONLY | O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1700:	a4450513          	addi	a0,a0,-1468 # 6140 <malloc+0x17a>
  ...
  exit(xstatus);
    ...
    171e:	26e50513          	addi	a0,a0,622 # 6988 <malloc+0x9c2>
    1722:	00004097          	auipc	ra,0x4
    1726:	7ec080e7          	jalr	2028(ra) # 5f0e <printf>
      exit(1);
    172a:	4505                	li	a0,1
    ...
    173c:	2a050513          	addi	a0,a0,672 # 69d8 <malloc+0xa12>
    1740:	00004097          	auipc	ra,0x4
    1744:	7ce080e7          	jalr	1998(ra) # 5f0e <printf>
      exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <exectest>:
{
  ...
  char *echoargv[] = {"echo", "OK", 0};
    ...
    1764:	98878793          	addi	a5,a5,-1656 # 60e8 <malloc+0x122>
    1768:	fcf43023          	sd	a5,-64(s0)
    176c:	00005797          	auipc	a5,0x5
    1770:	28c78793          	addi	a5,a5,652 # 69f8 <malloc+0xa32>
    1774:	fcf43423          	sd	a5,-56(s0)
    1778:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    177c:	00005517          	auipc	a0,0x5
    1780:	28450513          	addi	a0,a0,644 # 6a00 <malloc+0xa3a>
  ...
  if (pid == 0)
    ...
    17ae:	25650513          	addi	a0,a0,598 # 6a00 <malloc+0xa3a>
    ...
    17ca:	25a50513          	addi	a0,a0,602 # 6a20 <malloc+0xa5a>
    17ce:	00004097          	auipc	ra,0x4
    17d2:	740080e7          	jalr	1856(ra) # 5f0e <printf>
      exit(1);
    17d6:	4505                	li	a0,1
    ...
    17e6:	18e50513          	addi	a0,a0,398 # 6970 <malloc+0x9aa>
    17ea:	00004097          	auipc	ra,0x4
    17ee:	724080e7          	jalr	1828(ra) # 5f0e <printf>
    exit(1);
    17f2:	4505                	li	a0,1
    ...
    1802:	20a50513          	addi	a0,a0,522 # 6a08 <malloc+0xa42>
    1806:	00004097          	auipc	ra,0x4
    180a:	708080e7          	jalr	1800(ra) # 5f0e <printf>
      exit(1);
    180e:	4505                	li	a0,1
    ...
    1820:	8cc50513          	addi	a0,a0,-1844 # 60e8 <malloc+0x122>
  ...
  if (xstatus != 0)
    ...
    1854:	1e050513          	addi	a0,a0,480 # 6a30 <malloc+0xa6a>
    1858:	00004097          	auipc	ra,0x4
    185c:	6b6080e7          	jalr	1718(ra) # 5f0e <printf>
      exit(1);
    1860:	4505                	li	a0,1
    ...
    1870:	1dc50513          	addi	a0,a0,476 # 6a48 <malloc+0xa82>
    1874:	00004097          	auipc	ra,0x4
    1878:	69a080e7          	jalr	1690(ra) # 5f0e <printf>
    187c:	b7d1                	j	1840 <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    187e:	4581                	li	a1,0
    1880:	00005517          	auipc	a0,0x5
    1884:	18050513          	addi	a0,a0,384 # 6a00 <malloc+0xa3a>
  ...
  if (read(fd, buf, 2) != 2)
    ...
    18ae:	c0e50513          	addi	a0,a0,-1010 # 64b8 <malloc+0x4f2>
    18b2:	00004097          	auipc	ra,0x4
    18b6:	65c080e7          	jalr	1628(ra) # 5f0e <printf>
    exit(1);
    18ba:	4505                	li	a0,1
    ...
    18ca:	0c250513          	addi	a0,a0,194 # 6988 <malloc+0x9c2>
    18ce:	00004097          	auipc	ra,0x4
    18d2:	640080e7          	jalr	1600(ra) # 5f0e <printf>
    exit(1);
    18d6:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    18e4:	12050513          	addi	a0,a0,288 # 6a00 <malloc+0xa3a>
  ...
  if (buf[0] == 'O' && buf[1] == 'K')
    ...
    190e:	15650513          	addi	a0,a0,342 # 6a60 <malloc+0xa9a>
    1912:	00004097          	auipc	ra,0x4
    1916:	5fc080e7          	jalr	1532(ra) # 5f0e <printf>
    exit(1);
    191a:	4505                	li	a0,1
...
000000000000192e <pipe1>:
{
  ...
  if (pid == 0)
    ...
    19ce:	0ae50513          	addi	a0,a0,174 # 6a78 <malloc+0xab2>
    19d2:	00004097          	auipc	ra,0x4
    19d6:	53c080e7          	jalr	1340(ra) # 5f0e <printf>
    exit(1);
    19da:	4505                	li	a0,1
    ...
    1a08:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x8b>
{
    ...
    1a54:	04050513          	addi	a0,a0,64 # 6a90 <malloc+0xaca>
    1a58:	00004097          	auipc	ra,0x4
    1a5c:	4b6080e7          	jalr	1206(ra) # 5f0e <printf>
        exit(1);
    1a60:	4505                	li	a0,1
    ...
    1a70:	03c50513          	addi	a0,a0,60 # 6aa8 <malloc+0xae2>
    1a74:	00004097          	auipc	ra,0x4
    1a78:	49a080e7          	jalr	1178(ra) # 5f0e <printf>
}
    ...
    1aa2:	02250513          	addi	a0,a0,34 # 6ac0 <malloc+0xafa>
    1aa6:	00004097          	auipc	ra,0x4
    1aaa:	468080e7          	jalr	1128(ra) # 5f0e <printf>
      exit(1);
    1aae:	4505                	li	a0,1
    ...
    1ae2:	00250513          	addi	a0,a0,2 # 6ae0 <malloc+0xb1a>
    1ae6:	00004097          	auipc	ra,0x4
    1aea:	428080e7          	jalr	1064(ra) # 5f0e <printf>
    exit(1);
    1aee:	4505                	li	a0,1
...
0000000000001af8 <exitwait>:
{
  ...
  for (i = 0; i < 100; i++)
    ...
    1b54:	e2050513          	addi	a0,a0,-480 # 6970 <malloc+0x9aa>
    1b58:	00004097          	auipc	ra,0x4
    1b5c:	3b6080e7          	jalr	950(ra) # 5f0e <printf>
      exit(1);
    1b60:	4505                	li	a0,1
    ...
    1b70:	f8c50513          	addi	a0,a0,-116 # 6af8 <malloc+0xb32>
    1b74:	00004097          	auipc	ra,0x4
    1b78:	39a080e7          	jalr	922(ra) # 5f0e <printf>
        exit(1);
    1b7c:	4505                	li	a0,1
    ...
    1b8c:	f8850513          	addi	a0,a0,-120 # 6b10 <malloc+0xb4a>
    1b90:	00004097          	auipc	ra,0x4
    1b94:	37e080e7          	jalr	894(ra) # 5f0e <printf>
        exit(1);
    1b98:	4505                	li	a0,1
...
0000000000001bac <twochildren>:
{
  ...
  for (int i = 0; i < 1000; i++)
    ...
    1c04:	d7050513          	addi	a0,a0,-656 # 6970 <malloc+0x9aa>
    1c08:	00004097          	auipc	ra,0x4
    1c0c:	306080e7          	jalr	774(ra) # 5f0e <printf>
      exit(1);
    1c10:	4505                	li	a0,1
    ...
    1c28:	d4c50513          	addi	a0,a0,-692 # 6970 <malloc+0x9aa>
    1c2c:	00004097          	auipc	ra,0x4
    1c30:	2e2080e7          	jalr	738(ra) # 5f0e <printf>
        exit(1);
    1c34:	4505                	li	a0,1
...
0000000000001c46 <forkfork>:
{
    ...
    1ca2:	e9250513          	addi	a0,a0,-366 # 6b30 <malloc+0xb6a>
    1ca6:	00004097          	auipc	ra,0x4
    1caa:	268080e7          	jalr	616(ra) # 5f0e <printf>
      exit(1);
    1cae:	4505                	li	a0,1
    ...
    1cb4:	eb4080e7          	jalr	-332(ra) # 5b64 <exit>
{
    ...
    1cfa:	e4a50513          	addi	a0,a0,-438 # 6b40 <malloc+0xb7a>
    1cfe:	00004097          	auipc	ra,0x4
    1d02:	210080e7          	jalr	528(ra) # 5f0e <printf>
      exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d10 <reparent2>:
{
  ...
  exit(0);
    ...
    1d48:	03450513          	addi	a0,a0,52 # 6d78 <malloc+0xdb2>
    1d4c:	00004097          	auipc	ra,0x4
    1d50:	1c2080e7          	jalr	450(ra) # 5f0e <printf>
      exit(1);
    1d54:	4505                	li	a0,1
...
0000000000001d78 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1de6:	f9650513          	addi	a0,a0,-106 # 6d78 <malloc+0xdb2>
    1dea:	00004097          	auipc	ra,0x4
    1dee:	124080e7          	jalr	292(ra) # 5f0e <printf>
      exit(1);
    1df2:	4505                	li	a0,1
    ...
    1e12:	bfa50513          	addi	a0,a0,-1030 # 6a08 <malloc+0xa42>
    1e16:	00004097          	auipc	ra,0x4
    1e1a:	0f8080e7          	jalr	248(ra) # 5f0e <printf>
          exit(1);
    1e1e:	4505                	li	a0,1
    ...
    1e84:	ce050513          	addi	a0,a0,-800 # 6b60 <malloc+0xb9a>
    1e88:	00004097          	auipc	ra,0x4
    1e8c:	086080e7          	jalr	134(ra) # 5f0e <printf>
            exit(1);
    1e90:	4505                	li	a0,1
    ...
    1eb8:	cc450513          	addi	a0,a0,-828 # 6b78 <malloc+0xbb2>
    1ebc:	00004097          	auipc	ra,0x4
    1ec0:	052080e7          	jalr	82(ra) # 5f0e <printf>
        exit(1);
    1ec4:	4505                	li	a0,1
    ...
    1f1e:	c8650513          	addi	a0,a0,-890 # 6ba0 <malloc+0xbda>
    1f22:	00004097          	auipc	ra,0x4
    1f26:	fec080e7          	jalr	-20(ra) # 5f0e <printf>
        exit(1);
    1f2a:	4505                	li	a0,1
...
0000000000001f9e <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fbe:	19e50513          	addi	a0,a0,414 # 6158 <malloc+0x192>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1ffa:	162a8a93          	addi	s5,s5,354 # 6158 <malloc+0x192>
      link("cat", "x");
    1ffe:	00005b97          	auipc	s7,0x5
    2002:	bcab8b93          	addi	s7,s7,-1078 # 6bc8 <malloc+0xc02>
    2006:	a825                	j	203e <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    2008:	85a6                	mv	a1,s1
    200a:	00005517          	auipc	a0,0x5
    200e:	96650513          	addi	a0,a0,-1690 # 6970 <malloc+0x9aa>
    2012:	00004097          	auipc	ra,0x4
    2016:	efc080e7          	jalr	-260(ra) # 5f0e <printf>
    exit(1);
    201a:	4505                	li	a0,1
...
00000000000020a0 <forktest>:
{
  ...
  for (n = 0; n < N; n++)
    ...
    20d0:	b1c50513          	addi	a0,a0,-1252 # 6be8 <malloc+0xc22>
    20d4:	00004097          	auipc	ra,0x4
    20d8:	e3a080e7          	jalr	-454(ra) # 5f0e <printf>
    exit(1);
    20dc:	4505                	li	a0,1
  ...
  if (wait(0) != -1)
    ...
    2132:	aa250513          	addi	a0,a0,-1374 # 6bd0 <malloc+0xc0a>
    2136:	00004097          	auipc	ra,0x4
    213a:	dd8080e7          	jalr	-552(ra) # 5f0e <printf>
    exit(1);
    213e:	4505                	li	a0,1
    ...
    214e:	ac650513          	addi	a0,a0,-1338 # 6c10 <malloc+0xc4a>
    2152:	00004097          	auipc	ra,0x4
    2156:	dbc080e7          	jalr	-580(ra) # 5f0e <printf>
      exit(1);
    215a:	4505                	li	a0,1
    ...
    216a:	ac250513          	addi	a0,a0,-1342 # 6c28 <malloc+0xc62>
    216e:	00004097          	auipc	ra,0x4
    2172:	da0080e7          	jalr	-608(ra) # 5f0e <printf>
    exit(1);
    2176:	4505                	li	a0,1
...
0000000000002180 <kernmem>:
{
  ...
  for (a = (char *)(KERNBASE); a < (char *)(KERNBASE + 2000000); a += 50000)
    ...
    21ea:	78a50513          	addi	a0,a0,1930 # 6970 <malloc+0x9aa>
    21ee:	00004097          	auipc	ra,0x4
    21f2:	d20080e7          	jalr	-736(ra) # 5f0e <printf>
      exit(1);
    21f6:	4505                	li	a0,1
    ...
    220c:	a3850513          	addi	a0,a0,-1480 # 6c40 <malloc+0xc7a>
    2210:	00004097          	auipc	ra,0x4
    2214:	cfe080e7          	jalr	-770(ra) # 5f0e <printf>
      exit(1);
    2218:	4505                	li	a0,1
...
000000000000222c <MAXVAplus>:
{
  ...
  for (; a != 0; a <<= 1)
    ...
    228e:	6e650513          	addi	a0,a0,1766 # 6970 <malloc+0x9aa>
    2292:	00004097          	auipc	ra,0x4
    2296:	c7c080e7          	jalr	-900(ra) # 5f0e <printf>
      exit(1);
    229a:	4505                	li	a0,1
    ...
    22ba:	9aa50513          	addi	a0,a0,-1622 # 6c60 <malloc+0xc9a>
    22be:	00004097          	auipc	ra,0x4
    22c2:	c50080e7          	jalr	-944(ra) # 5f0e <printf>
      exit(1);
    22c6:	4505                	li	a0,1
...
00000000000022da <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22ea:	99250513          	addi	a0,a0,-1646 # 6c78 <malloc+0xcb2>
  ...
  fd = open("bigarg-ok", 0);
    ...
    231c:	96050513          	addi	a0,a0,-1696 # 6c78 <malloc+0xcb2>
  ...
  close(fd);
    ...
    2352:	93a70713          	addi	a4,a4,-1734 # 6c88 <malloc+0xcc2>
    ...
    23a6:	9c650513          	addi	a0,a0,-1594 # 6d68 <malloc+0xda2>
    23aa:	00004097          	auipc	ra,0x4
    23ae:	b64080e7          	jalr	-1180(ra) # 5f0e <printf>
    exit(1);
    23b2:	4505                	li	a0,1
    ...
    23ca:	9c250513          	addi	a0,a0,-1598 # 6d88 <malloc+0xdc2>
    23ce:	00004097          	auipc	ra,0x4
    23d2:	b40080e7          	jalr	-1216(ra) # 5f0e <printf>
    exit(1);
    23d6:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp"
    ...
    2428:	98450513          	addi	a0,a0,-1660 # 6da8 <malloc+0xde2>
    242c:	00004097          	auipc	ra,0x4
    2430:	ae2080e7          	jalr	-1310(ra) # 5f0e <printf>
    exit(1);
    2434:	4505                	li	a0,1
    ...
    2444:	53050513          	addi	a0,a0,1328 # 6970 <malloc+0x9aa>
    2448:	00004097          	auipc	ra,0x4
    244c:	ac6080e7          	jalr	-1338(ra) # 5f0e <printf>
    exit(1);
    2450:	4505                	li	a0,1
...
0000000000002464 <manywrites>:
{
  ...
  exit(0);
    ...
    24c0:	8bc50513          	addi	a0,a0,-1860 # 6d78 <malloc+0xdb2>
    24c4:	00004097          	auipc	ra,0x4
    24c8:	a4a080e7          	jalr	-1462(ra) # 5f0e <printf>
      exit(1);
    24cc:	4505                	li	a0,1
    ...
    2570:	86450513          	addi	a0,a0,-1948 # 6dd0 <malloc+0xe0a>
    2574:	00004097          	auipc	ra,0x4
    2578:	99a080e7          	jalr	-1638(ra) # 5f0e <printf>
            exit(1);
    257c:	4505                	li	a0,1
    ...
    2590:	c2c50513          	addi	a0,a0,-980 # 61b8 <malloc+0x1f2>
    2594:	00004097          	auipc	ra,0x4
    2598:	97a080e7          	jalr	-1670(ra) # 5f0e <printf>
            exit(1);
    259c:	4505                	li	a0,1
...
00000000000025ae <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = {"xx", 0};
    ...
    2628:	4a478793          	addi	a5,a5,1188 # 7ac8 <malloc+0x1b02>
  ...
  if (ret != -1)
    ...
    266a:	78250513          	addi	a0,a0,1922 # 6de8 <malloc+0xe22>
    266e:	00004097          	auipc	ra,0x4
    2672:	8a0080e7          	jalr	-1888(ra) # 5f0e <printf>
    exit(1);
    2676:	4505                	li	a0,1
    ...
    2688:	20c50513          	addi	a0,a0,524 # 6890 <malloc+0x8ca>
    268c:	00004097          	auipc	ra,0x4
    2690:	882080e7          	jalr	-1918(ra) # 5f0e <printf>
    exit(1);
    2694:	4505                	li	a0,1
    ...
    26a6:	20e50513          	addi	a0,a0,526 # 68b0 <malloc+0x8ea>
    26aa:	00004097          	auipc	ra,0x4
    26ae:	864080e7          	jalr	-1948(ra) # 5f0e <printf>
    exit(1);
    26b2:	4505                	li	a0,1
    ...
    26c6:	20e50513          	addi	a0,a0,526 # 68d0 <malloc+0x90a>
    ...
    26e4:	21850513          	addi	a0,a0,536 # 68f8 <malloc+0x932>
...
00000000000026fa <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE | O_WRONLY);
    ...
    2730:	6fc50513          	addi	a0,a0,1788 # 6e28 <malloc+0xe62>
  ...
  if (n >= 0)
    ...
    2760:	6ec50513          	addi	a0,a0,1772 # 6e48 <malloc+0xe82>
    2764:	00003097          	auipc	ra,0x3
    2768:	7aa080e7          	jalr	1962(ra) # 5f0e <printf>
    exit(1);
    276c:	4505                	li	a0,1
    ...
    277a:	67a50513          	addi	a0,a0,1658 # 6df0 <malloc+0xe2a>
    277e:	00003097          	auipc	ra,0x3
    2782:	790080e7          	jalr	1936(ra) # 5f0e <printf>
    exit(1);
    2786:	4505                	li	a0,1
    ...
    2794:	67850513          	addi	a0,a0,1656 # 6e08 <malloc+0xe42>
    2798:	00003097          	auipc	ra,0x3
    279c:	776080e7          	jalr	1910(ra) # 5f0e <printf>
    exit(1);
    27a0:	4505                	li	a0,1
    ...
    27ae:	68650513          	addi	a0,a0,1670 # 6e30 <malloc+0xe6a>
    27b2:	00003097          	auipc	ra,0x3
    27b6:	75c080e7          	jalr	1884(ra) # 5f0e <printf>
    exit(1);
    27ba:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    27d2:	65a50513          	addi	a0,a0,1626 # 6e28 <malloc+0xe62>
    27d6:	00003097          	auipc	ra,0x3
    27da:	3de080e7          	jalr	990(ra) # 5bb4 <unlink>
  fd = open("README", O_RDONLY);
    27de:	4581                	li	a1,0
    27e0:	00004517          	auipc	a0,0x4
    27e4:	ae050513          	addi	a0,a0,-1312 # 62c0 <malloc+0x2fa>
  ...
  if (n >= 0)
    ...
    280e:	66e50513          	addi	a0,a0,1646 # 6e78 <malloc+0xeb2>
    2812:	00003097          	auipc	ra,0x3
    2816:	6fc080e7          	jalr	1788(ra) # 5f0e <printf>
    exit(1);
    281a:	4505                	li	a0,1
    ...
    2828:	60c50513          	addi	a0,a0,1548 # 6e30 <malloc+0xe6a>
    282c:	00003097          	auipc	ra,0x3
    2830:	6e2080e7          	jalr	1762(ra) # 5f0e <printf>
    exit(1);
    2834:	4505                	li	a0,1
...
0000000000002852 <sbrkbasic>:
{
  ...
  if (pid == 0)
    ...
    28a8:	5fc50513          	addi	a0,a0,1532 # 6ea0 <malloc+0xeda>
    28ac:	00003097          	auipc	ra,0x3
    28b0:	662080e7          	jalr	1634(ra) # 5f0e <printf>
    exit(1);
    28b4:	4505                	li	a0,1
  ...
  for (i = 0; i < 5000; i++)
    ...
    28fa:	5ca50513          	addi	a0,a0,1482 # 6ec0 <malloc+0xefa>
    28fe:	00003097          	auipc	ra,0x3
    2902:	610080e7          	jalr	1552(ra) # 5f0e <printf>
    exit(1);
    2906:	4505                	li	a0,1
  ...
  if (c != a + 1)
    ...
    295e:	5c650513          	addi	a0,a0,1478 # 6f20 <malloc+0xf5a>
    2962:	00003097          	auipc	ra,0x3
    2966:	5ac080e7          	jalr	1452(ra) # 5f0e <printf>
    exit(1);
    296a:	4505                	li	a0,1
    ...
    2980:	56450513          	addi	a0,a0,1380 # 6ee0 <malloc+0xf1a>
    2984:	00003097          	auipc	ra,0x3
    2988:	58a080e7          	jalr	1418(ra) # 5f0e <printf>
      exit(1);
    298c:	4505                	li	a0,1
    ...
    299c:	56850513          	addi	a0,a0,1384 # 6f00 <malloc+0xf3a>
    29a0:	00003097          	auipc	ra,0x3
    29a4:	56e080e7          	jalr	1390(ra) # 5f0e <printf>
    exit(1);
    29a8:	4505                	li	a0,1
...
00000000000029d8 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if (c != a)
    ...
    2ae6:	45e50513          	addi	a0,a0,1118 # 6f40 <malloc+0xf7a>
    2aea:	00003097          	auipc	ra,0x3
    2aee:	424080e7          	jalr	1060(ra) # 5f0e <printf>
    exit(1);
    2af2:	4505                	li	a0,1
    ...
    2b02:	48a50513          	addi	a0,a0,1162 # 6f88 <malloc+0xfc2>
    2b06:	00003097          	auipc	ra,0x3
    2b0a:	408080e7          	jalr	1032(ra) # 5f0e <printf>
    exit(1);
    2b0e:	4505                	li	a0,1
    ...
    2b22:	48a50513          	addi	a0,a0,1162 # 6fa8 <malloc+0xfe2>
    2b26:	00003097          	auipc	ra,0x3
    2b2a:	3e8080e7          	jalr	1000(ra) # 5f0e <printf>
    exit(1);
    2b2e:	4505                	li	a0,1
    ...
    2b42:	4aa50513          	addi	a0,a0,1194 # 6fe8 <malloc+0x1022>
    ...
    2b5e:	4be50513          	addi	a0,a0,1214 # 7018 <malloc+0x1052>
    ...
    2b7e:	4d650513          	addi	a0,a0,1238 # 7050 <malloc+0x108a>
...
0000000000002b94 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE | O_WRONLY);
    ...
    2bb8:	4c450513          	addi	a0,a0,1220 # 7078 <malloc+0x10b2>
    2bbc:	00003097          	auipc	ra,0x3
    2bc0:	fe8080e7          	jalr	-24(ra) # 5ba4 <open>
    2bc4:	84aa                	mv	s1,a0
  unlink("sbrk");
    2bc6:	00004517          	auipc	a0,0x4
    2bca:	4b250513          	addi	a0,a0,1202 # 7078 <malloc+0x10b2>
  ...
  if (pipe((int *)a) != 0)
    ...
    2c1e:	46650513          	addi	a0,a0,1126 # 7080 <malloc+0x10ba>
    2c22:	00003097          	auipc	ra,0x3
    2c26:	2ec080e7          	jalr	748(ra) # 5f0e <printf>
    exit(1);
    2c2a:	4505                	li	a0,1
    ...
    2c3a:	46250513          	addi	a0,a0,1122 # 7098 <malloc+0x10d2>
    2c3e:	00003097          	auipc	ra,0x3
    2c42:	2d0080e7          	jalr	720(ra) # 5f0e <printf>
    exit(1);
    2c46:	4505                	li	a0,1
    ...
    2c56:	e2650513          	addi	a0,a0,-474 # 6a78 <malloc+0xab2>
    2c5a:	00003097          	auipc	ra,0x3
    2c5e:	2b4080e7          	jalr	692(ra) # 5f0e <printf>
    exit(1);
    2c62:	4505                	li	a0,1
...
0000000000002c6c <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2c80:	43450513          	addi	a0,a0,1076 # 70b0 <malloc+0x10ea>
  ...
  close(fd);
    ...
    2cc8:	cc450513          	addi	a0,a0,-828 # 6988 <malloc+0x9c2>
    2ccc:	00003097          	auipc	ra,0x3
    2cd0:	242080e7          	jalr	578(ra) # 5f0e <printf>
    exit(1);
    2cd4:	4505                	li	a0,1
...
0000000000002cde <sbrkbugs>:
{
  ...
  if (pid == 0)
    ...
    2d16:	06650513          	addi	a0,a0,102 # 6d78 <malloc+0xdb2>
    2d1a:	00003097          	auipc	ra,0x3
    2d1e:	1f4080e7          	jalr	500(ra) # 5f0e <printf>
    exit(1);
    2d22:	4505                	li	a0,1
  ...
  if (pid == 0)
    ...
    2d6c:	01050513          	addi	a0,a0,16 # 6d78 <malloc+0xdb2>
    2d70:	00003097          	auipc	ra,0x3
    2d74:	19e080e7          	jalr	414(ra) # 5f0e <printf>
    exit(1);
    2d78:	4505                	li	a0,1
  ...
  if (pid == 0)
    ...
    2dcc:	fb050513          	addi	a0,a0,-80 # 6d78 <malloc+0xdb2>
    2dd0:	00003097          	auipc	ra,0x3
    2dd4:	13e080e7          	jalr	318(ra) # 5f0e <printf>
    exit(1);
    2dd8:	4505                	li	a0,1
...
0000000000002efe <execout>:
{
  ...
  exit(0);
    ...
    2f40:	e3c50513          	addi	a0,a0,-452 # 6d78 <malloc+0xdb2>
    2f44:	00003097          	auipc	ra,0x3
    2f48:	fca080e7          	jalr	-54(ra) # 5f0e <printf>
      exit(1);
    2f4c:	4505                	li	a0,1
    ...
    2f94:	15850513          	addi	a0,a0,344 # 60e8 <malloc+0x122>
    2f98:	faa43c23          	sd	a0,-72(s0)
    2f9c:	00003797          	auipc	a5,0x3
    2fa0:	1bc78793          	addi	a5,a5,444 # 6158 <malloc+0x192>
...
0000000000002fc2 <fourteen>:
{
  ...
  if (mkdir("12345678901234") != 0)
    ...
    2fd2:	2ba50513          	addi	a0,a0,698 # 7288 <malloc+0x12c2>
  ...
  if (mkdir("12345678901234/123456789012345") != 0)
    ...
    2fe4:	10050513          	addi	a0,a0,256 # 70e0 <malloc+0x111a>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2ffa:	14250513          	addi	a0,a0,322 # 7138 <malloc+0x1172>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    3018:	19c50513          	addi	a0,a0,412 # 71b0 <malloc+0x11ea>
  ...
  if (mkdir("12345678901234/12345678901234") == 0)
    ...
    3034:	1f050513          	addi	a0,a0,496 # 7220 <malloc+0x125a>
  ...
  if (mkdir("123456789012345/12345678901234") == 0)
    ...
    3046:	23650513          	addi	a0,a0,566 # 7278 <malloc+0x12b2>
  ...
  unlink("12345678901234");
    ...
    30c4:	ff850513          	addi	a0,a0,-8 # 70b8 <malloc+0x10f2>
    30c8:	00003097          	auipc	ra,0x3
    30cc:	e46080e7          	jalr	-442(ra) # 5f0e <printf>
    exit(1);
    30d0:	4505                	li	a0,1
    ...
    30e0:	02450513          	addi	a0,a0,36 # 7100 <malloc+0x113a>
    30e4:	00003097          	auipc	ra,0x3
    30e8:	e2a080e7          	jalr	-470(ra) # 5f0e <printf>
    exit(1);
    30ec:	4505                	li	a0,1
    ...
    30fc:	07050513          	addi	a0,a0,112 # 7168 <malloc+0x11a2>
    3100:	00003097          	auipc	ra,0x3
    3104:	e0e080e7          	jalr	-498(ra) # 5f0e <printf>
    exit(1);
    3108:	4505                	li	a0,1
    ...
    3118:	0cc50513          	addi	a0,a0,204 # 71e0 <malloc+0x121a>
    311c:	00003097          	auipc	ra,0x3
    3120:	df2080e7          	jalr	-526(ra) # 5f0e <printf>
    exit(1);
    3124:	4505                	li	a0,1
    ...
    3134:	11050513          	addi	a0,a0,272 # 7240 <malloc+0x127a>
    3138:	00003097          	auipc	ra,0x3
    313c:	dd6080e7          	jalr	-554(ra) # 5f0e <printf>
    exit(1);
    3140:	4505                	li	a0,1
    ...
    3150:	14c50513          	addi	a0,a0,332 # 7298 <malloc+0x12d2>
    3154:	00003097          	auipc	ra,0x3
    3158:	dba080e7          	jalr	-582(ra) # 5f0e <printf>
    exit(1);
    315c:	4505                	li	a0,1
...
0000000000003166 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    319c:	13850513          	addi	a0,a0,312 # 72d0 <malloc+0x130a>
  ...
  for (fi = 0; done == 0; fi++)
    ...
    31c6:	11e50513          	addi	a0,a0,286 # 72e0 <malloc+0x131a>
    31ca:	00003097          	auipc	ra,0x3
    31ce:	d44080e7          	jalr	-700(ra) # 5f0e <printf>
      break;
  ...
  if (mkdir("diskfulldir") == 0)
    ...
    3256:	07e50513          	addi	a0,a0,126 # 72d0 <malloc+0x130a>
  ...
  unlink("diskfulldir");
    ...
    326a:	06a50513          	addi	a0,a0,106 # 72d0 <malloc+0x130a>
  ...
  for (fi = 0; done == 0; fi++)
    ...
    3398:	f6c50513          	addi	a0,a0,-148 # 7300 <malloc+0x133a>
    339c:	00003097          	auipc	ra,0x3
    33a0:	b72080e7          	jalr	-1166(ra) # 5f0e <printf>
...
00000000000033a6 <iputtest>:
{
  ...
  if (mkdir("iputdir") < 0)
    ...
    33b6:	f7e50513          	addi	a0,a0,-130 # 7330 <malloc+0x136a>
  ...
  if (chdir("iputdir") < 0)
    ...
    33ca:	f6a50513          	addi	a0,a0,-150 # 7330 <malloc+0x136a>
  ...
  if (unlink("../iputdir") < 0)
    ...
    33de:	f9650513          	addi	a0,a0,-106 # 7370 <malloc+0x13aa>
  ...
  if (chdir("/") < 0)
    ...
    33f2:	fb250513          	addi	a0,a0,-78 # 73a0 <malloc+0x13da>
    ...
    3412:	f2a50513          	addi	a0,a0,-214 # 7338 <malloc+0x1372>
    3416:	00003097          	auipc	ra,0x3
    341a:	af8080e7          	jalr	-1288(ra) # 5f0e <printf>
    exit(1);
    341e:	4505                	li	a0,1
    ...
    342e:	f2650513          	addi	a0,a0,-218 # 7350 <malloc+0x138a>
    3432:	00003097          	auipc	ra,0x3
    3436:	adc080e7          	jalr	-1316(ra) # 5f0e <printf>
    exit(1);
    343a:	4505                	li	a0,1
    ...
    344a:	f3a50513          	addi	a0,a0,-198 # 7380 <malloc+0x13ba>
    344e:	00003097          	auipc	ra,0x3
    3452:	ac0080e7          	jalr	-1344(ra) # 5f0e <printf>
    exit(1);
    3456:	4505                	li	a0,1
    ...
    3466:	f4650513          	addi	a0,a0,-186 # 73a8 <malloc+0x13e2>
    346a:	00003097          	auipc	ra,0x3
    346e:	aa4080e7          	jalr	-1372(ra) # 5f0e <printf>
    exit(1);
    3472:	4505                	li	a0,1
...
000000000000347c <exitiputtest>:
{
  ...
  if (pid == 0)
    ...
    349a:	e9a50513          	addi	a0,a0,-358 # 7330 <malloc+0x136a>
    ...
    34ae:	e8650513          	addi	a0,a0,-378 # 7330 <malloc+0x136a>
    ...
    34c2:	eb250513          	addi	a0,a0,-334 # 7370 <malloc+0x13aa>
    ...
    34e2:	49250513          	addi	a0,a0,1170 # 6970 <malloc+0x9aa>
    34e6:	00003097          	auipc	ra,0x3
    34ea:	a28080e7          	jalr	-1496(ra) # 5f0e <printf>
    exit(1);
    34ee:	4505                	li	a0,1
    ...
    34fe:	e3e50513          	addi	a0,a0,-450 # 7338 <malloc+0x1372>
    3502:	00003097          	auipc	ra,0x3
    3506:	a0c080e7          	jalr	-1524(ra) # 5f0e <printf>
      exit(1);
    350a:	4505                	li	a0,1
    ...
    351a:	eaa50513          	addi	a0,a0,-342 # 73c0 <malloc+0x13fa>
    351e:	00003097          	auipc	ra,0x3
    3522:	9f0080e7          	jalr	-1552(ra) # 5f0e <printf>
      exit(1);
    3526:	4505                	li	a0,1
    ...
    353e:	9d4080e7          	jalr	-1580(ra) # 5f0e <printf>
      exit(1);
    3542:	4505                	li	a0,1
...
0000000000003564 <dirtest>:
{
  ...
  if (mkdir("dir0") < 0)
    ...
    3574:	e6850513          	addi	a0,a0,-408 # 73d8 <malloc+0x1412>
  ...
  if (chdir("dir0") < 0)
    ...
    3588:	e5450513          	addi	a0,a0,-428 # 73d8 <malloc+0x1412>
  ...
  if (chdir("..") < 0)
    ...
    359c:	e6050513          	addi	a0,a0,-416 # 73f8 <malloc+0x1432>
  ...
  if (unlink("dir0") < 0)
    ...
    35b0:	e2c50513          	addi	a0,a0,-468 # 73d8 <malloc+0x1412>
    ...
    35d0:	d6c50513          	addi	a0,a0,-660 # 7338 <malloc+0x1372>
    35d4:	00003097          	auipc	ra,0x3
    35d8:	93a080e7          	jalr	-1734(ra) # 5f0e <printf>
    exit(1);
    35dc:	4505                	li	a0,1
    ...
    35ec:	df850513          	addi	a0,a0,-520 # 73e0 <malloc+0x141a>
    35f0:	00003097          	auipc	ra,0x3
    35f4:	91e080e7          	jalr	-1762(ra) # 5f0e <printf>
    exit(1);
    35f8:	4505                	li	a0,1
    ...
    3608:	dfc50513          	addi	a0,a0,-516 # 7400 <malloc+0x143a>
    360c:	00003097          	auipc	ra,0x3
    3610:	902080e7          	jalr	-1790(ra) # 5f0e <printf>
    exit(1);
    3614:	4505                	li	a0,1
    ...
    3624:	df850513          	addi	a0,a0,-520 # 7418 <malloc+0x1452>
    3628:	00003097          	auipc	ra,0x3
    362c:	8e6080e7          	jalr	-1818(ra) # 5f0e <printf>
    exit(1);
    3630:	4505                	li	a0,1
...
000000000000363a <subdir>:
{
  ...
  unlink("ff");
    ...
    364c:	f1850513          	addi	a0,a0,-232 # 7560 <malloc+0x159a>
    3650:	00002097          	auipc	ra,0x2
    3654:	564080e7          	jalr	1380(ra) # 5bb4 <unlink>
  if (mkdir("dd") != 0)
    3658:	00004517          	auipc	a0,0x4
    365c:	dd850513          	addi	a0,a0,-552 # 7430 <malloc+0x146a>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3674:	de050513          	addi	a0,a0,-544 # 7450 <malloc+0x148a>
  ...
  write(fd, "ff", 2);
    ...
    368c:	ed858593          	addi	a1,a1,-296 # 7560 <malloc+0x159a>
  ...
  if (unlink("dd") >= 0)
    ...
    36a6:	d8e50513          	addi	a0,a0,-626 # 7430 <malloc+0x146a>
  ...
  if (mkdir("/dd/dd") != 0)
    ...
    36ba:	df250513          	addi	a0,a0,-526 # 74a8 <malloc+0x14e2>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    36d2:	e0250513          	addi	a0,a0,-510 # 74d0 <malloc+0x150a>
  ...
  write(fd, "FF", 2);
    ...
    36ea:	e1a58593          	addi	a1,a1,-486 # 7500 <malloc+0x153a>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3706:	e0650513          	addi	a0,a0,-506 # 7508 <malloc+0x1542>
  ...
  if (link("dd/dd/ff", "dd/dd/ffff") != 0)
    ...
    374e:	e0e58593          	addi	a1,a1,-498 # 7558 <malloc+0x1592>
    3752:	00004517          	auipc	a0,0x4
    3756:	d7e50513          	addi	a0,a0,-642 # 74d0 <malloc+0x150a>
  ...
  if (unlink("dd/dd/ff") != 0)
    ...
    376a:	d6a50513          	addi	a0,a0,-662 # 74d0 <malloc+0x150a>
  ...
  if (open("dd/dd/ff", O_RDONLY) >= 0)
    ...
    3780:	d5450513          	addi	a0,a0,-684 # 74d0 <malloc+0x150a>
  ...
  if (chdir("dd") != 0)
    ...
    3794:	ca050513          	addi	a0,a0,-864 # 7430 <malloc+0x146a>
  ...
  if (chdir("dd/../../dd") != 0)
    ...
    37a8:	e4c50513          	addi	a0,a0,-436 # 75f0 <malloc+0x162a>
  ...
  if (chdir("dd/../../../dd") != 0)
    ...
    37bc:	e6850513          	addi	a0,a0,-408 # 7620 <malloc+0x165a>
  ...
  if (chdir("./..") != 0)
    ...
    37d0:	e8450513          	addi	a0,a0,-380 # 7650 <malloc+0x168a>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    37e6:	d7650513          	addi	a0,a0,-650 # 7558 <malloc+0x1592>
  ...
  if (open("dd/dd/ff", O_RDONLY) >= 0)
    ...
    3820:	cb450513          	addi	a0,a0,-844 # 74d0 <malloc+0x150a>
  ...
  if (open("dd/ff/ff", O_CREATE | O_RDWR) >= 0)
    ...
    3838:	eac50513          	addi	a0,a0,-340 # 76e0 <malloc+0x171a>
  ...
  if (open("dd/xx/ff", O_CREATE | O_RDWR) >= 0)
    ...
    3850:	ec450513          	addi	a0,a0,-316 # 7710 <malloc+0x174a>
  ...
  if (open("dd", O_CREATE) >= 0)
    ...
    3868:	bcc50513          	addi	a0,a0,-1076 # 7430 <malloc+0x146a>
  ...
  if (open("dd", O_RDWR) >= 0)
    ...
    387e:	bb650513          	addi	a0,a0,-1098 # 7430 <malloc+0x146a>
  ...
  if (open("dd", O_WRONLY) >= 0)
    ...
    3894:	ba050513          	addi	a0,a0,-1120 # 7430 <malloc+0x146a>
  ...
  if (link("dd/ff/ff", "dd/dd/xx") == 0)
    ...
    38a8:	efc58593          	addi	a1,a1,-260 # 77a0 <malloc+0x17da>
    38ac:	00004517          	auipc	a0,0x4
    38b0:	e3450513          	addi	a0,a0,-460 # 76e0 <malloc+0x171a>
  ...
  if (link("dd/xx/ff", "dd/dd/xx") == 0)
    ...
    38c4:	ee058593          	addi	a1,a1,-288 # 77a0 <malloc+0x17da>
    38c8:	00004517          	auipc	a0,0x4
    38cc:	e4850513          	addi	a0,a0,-440 # 7710 <malloc+0x174a>
  ...
  if (link("dd/ff", "dd/dd/ffff") == 0)
    ...
    38e0:	c7c58593          	addi	a1,a1,-900 # 7558 <malloc+0x1592>
    38e4:	00004517          	auipc	a0,0x4
    38e8:	b6c50513          	addi	a0,a0,-1172 # 7450 <malloc+0x148a>
  ...
  if (mkdir("dd/ff/ff") == 0)
    ...
    38fc:	de850513          	addi	a0,a0,-536 # 76e0 <malloc+0x171a>
  ...
  if (mkdir("dd/xx/ff") == 0)
    ...
    3910:	e0450513          	addi	a0,a0,-508 # 7710 <malloc+0x174a>
  ...
  if (mkdir("dd/dd/ffff") == 0)
    ...
    3924:	c3850513          	addi	a0,a0,-968 # 7558 <malloc+0x1592>
  ...
  if (unlink("dd/xx/ff") == 0)
    ...
    3938:	ddc50513          	addi	a0,a0,-548 # 7710 <malloc+0x174a>
  ...
  if (unlink("dd/ff/ff") == 0)
    ...
    394c:	d9850513          	addi	a0,a0,-616 # 76e0 <malloc+0x171a>
  ...
  if (chdir("dd/ff") == 0)
    ...
    3960:	af450513          	addi	a0,a0,-1292 # 7450 <malloc+0x148a>
  ...
  if (chdir("dd/xx") == 0)
    ...
    3974:	f8050513          	addi	a0,a0,-128 # 78f0 <malloc+0x192a>
  ...
  if (unlink("dd/dd/ffff") != 0)
    ...
    3988:	bd450513          	addi	a0,a0,-1068 # 7558 <malloc+0x1592>
  ...
  if (unlink("dd/ff") != 0)
    ...
    399c:	ab850513          	addi	a0,a0,-1352 # 7450 <malloc+0x148a>
  ...
  if (unlink("dd") == 0)
    ...
    39b0:	a8450513          	addi	a0,a0,-1404 # 7430 <malloc+0x146a>
  ...
  if (unlink("dd/dd") < 0)
    ...
    39c4:	fa050513          	addi	a0,a0,-96 # 7960 <malloc+0x199a>
  ...
  if (unlink("dd") < 0)
    ...
    39d8:	a5c50513          	addi	a0,a0,-1444 # 7430 <malloc+0x146a>
    ...
    39fa:	a4250513          	addi	a0,a0,-1470 # 7438 <malloc+0x1472>
    39fe:	00002097          	auipc	ra,0x2
    3a02:	510080e7          	jalr	1296(ra) # 5f0e <printf>
    exit(1);
    3a06:	4505                	li	a0,1
    ...
    3a16:	a4650513          	addi	a0,a0,-1466 # 7458 <malloc+0x1492>
    3a1a:	00002097          	auipc	ra,0x2
    3a1e:	4f4080e7          	jalr	1268(ra) # 5f0e <printf>
    exit(1);
    3a22:	4505                	li	a0,1
    ...
    3a32:	a4a50513          	addi	a0,a0,-1462 # 7478 <malloc+0x14b2>
    3a36:	00002097          	auipc	ra,0x2
    3a3a:	4d8080e7          	jalr	1240(ra) # 5f0e <printf>
    exit(1);
    3a3e:	4505                	li	a0,1
    ...
    3a4e:	a6650513          	addi	a0,a0,-1434 # 74b0 <malloc+0x14ea>
    3a52:	00002097          	auipc	ra,0x2
    3a56:	4bc080e7          	jalr	1212(ra) # 5f0e <printf>
    exit(1);
    3a5a:	4505                	li	a0,1
    ...
    3a6a:	a7a50513          	addi	a0,a0,-1414 # 74e0 <malloc+0x151a>
    3a6e:	00002097          	auipc	ra,0x2
    3a72:	4a0080e7          	jalr	1184(ra) # 5f0e <printf>
    exit(1);
    3a76:	4505                	li	a0,1
    ...
    3a86:	a9650513          	addi	a0,a0,-1386 # 7518 <malloc+0x1552>
    3a8a:	00002097          	auipc	ra,0x2
    3a8e:	484080e7          	jalr	1156(ra) # 5f0e <printf>
    exit(1);
    3a92:	4505                	li	a0,1
    ...
    3aa2:	a9a50513          	addi	a0,a0,-1382 # 7538 <malloc+0x1572>
    3aa6:	00002097          	auipc	ra,0x2
    3aaa:	468080e7          	jalr	1128(ra) # 5f0e <printf>
    exit(1);
    3aae:	4505                	li	a0,1
    ...
    3abe:	aae50513          	addi	a0,a0,-1362 # 7568 <malloc+0x15a2>
    3ac2:	00002097          	auipc	ra,0x2
    3ac6:	44c080e7          	jalr	1100(ra) # 5f0e <printf>
    exit(1);
    3aca:	4505                	li	a0,1
    ...
    3ada:	aba50513          	addi	a0,a0,-1350 # 7590 <malloc+0x15ca>
    3ade:	00002097          	auipc	ra,0x2
    3ae2:	430080e7          	jalr	1072(ra) # 5f0e <printf>
    exit(1);
    3ae6:	4505                	li	a0,1
    ...
    3af6:	abe50513          	addi	a0,a0,-1346 # 75b0 <malloc+0x15ea>
    3afa:	00002097          	auipc	ra,0x2
    3afe:	414080e7          	jalr	1044(ra) # 5f0e <printf>
    exit(1);
    3b02:	4505                	li	a0,1
    ...
    3b12:	aca50513          	addi	a0,a0,-1334 # 75d8 <malloc+0x1612>
    3b16:	00002097          	auipc	ra,0x2
    3b1a:	3f8080e7          	jalr	1016(ra) # 5f0e <printf>
    exit(1);
    3b1e:	4505                	li	a0,1
    ...
    3b2e:	ad650513          	addi	a0,a0,-1322 # 7600 <malloc+0x163a>
    3b32:	00002097          	auipc	ra,0x2
    3b36:	3dc080e7          	jalr	988(ra) # 5f0e <printf>
    exit(1);
    3b3a:	4505                	li	a0,1
    ...
    3b4a:	aea50513          	addi	a0,a0,-1302 # 7630 <malloc+0x166a>
    3b4e:	00002097          	auipc	ra,0x2
    3b52:	3c0080e7          	jalr	960(ra) # 5f0e <printf>
    exit(1);
    3b56:	4505                	li	a0,1
    ...
    3b66:	af650513          	addi	a0,a0,-1290 # 7658 <malloc+0x1692>
    3b6a:	00002097          	auipc	ra,0x2
    3b6e:	3a4080e7          	jalr	932(ra) # 5f0e <printf>
    exit(1);
    3b72:	4505                	li	a0,1
    ...
    3b82:	af250513          	addi	a0,a0,-1294 # 7670 <malloc+0x16aa>
    3b86:	00002097          	auipc	ra,0x2
    3b8a:	388080e7          	jalr	904(ra) # 5f0e <printf>
    exit(1);
    3b8e:	4505                	li	a0,1
    ...
    3b9e:	af650513          	addi	a0,a0,-1290 # 7690 <malloc+0x16ca>
    3ba2:	00002097          	auipc	ra,0x2
    3ba6:	36c080e7          	jalr	876(ra) # 5f0e <printf>
    exit(1);
    3baa:	4505                	li	a0,1
    ...
    3bba:	afa50513          	addi	a0,a0,-1286 # 76b0 <malloc+0x16ea>
    3bbe:	00002097          	auipc	ra,0x2
    3bc2:	350080e7          	jalr	848(ra) # 5f0e <printf>
    exit(1);
    3bc6:	4505                	li	a0,1
    ...
    3bd6:	b1e50513          	addi	a0,a0,-1250 # 76f0 <malloc+0x172a>
    3bda:	00002097          	auipc	ra,0x2
    3bde:	334080e7          	jalr	820(ra) # 5f0e <printf>
    exit(1);
    3be2:	4505                	li	a0,1
    ...
    3bf2:	b3250513          	addi	a0,a0,-1230 # 7720 <malloc+0x175a>
    3bf6:	00002097          	auipc	ra,0x2
    3bfa:	318080e7          	jalr	792(ra) # 5f0e <printf>
    exit(1);
    3bfe:	4505                	li	a0,1
    ...
    3c0e:	b3650513          	addi	a0,a0,-1226 # 7740 <malloc+0x177a>
    3c12:	00002097          	auipc	ra,0x2
    3c16:	2fc080e7          	jalr	764(ra) # 5f0e <printf>
    exit(1);
    3c1a:	4505                	li	a0,1
    ...
    3c2a:	b3a50513          	addi	a0,a0,-1222 # 7760 <malloc+0x179a>
    3c2e:	00002097          	auipc	ra,0x2
    3c32:	2e0080e7          	jalr	736(ra) # 5f0e <printf>
    exit(1);
    3c36:	4505                	li	a0,1
    ...
    3c46:	b3e50513          	addi	a0,a0,-1218 # 7780 <malloc+0x17ba>
    3c4a:	00002097          	auipc	ra,0x2
    3c4e:	2c4080e7          	jalr	708(ra) # 5f0e <printf>
    exit(1);
    3c52:	4505                	li	a0,1
    ...
    3c62:	b5250513          	addi	a0,a0,-1198 # 77b0 <malloc+0x17ea>
    3c66:	00002097          	auipc	ra,0x2
    3c6a:	2a8080e7          	jalr	680(ra) # 5f0e <printf>
    exit(1);
    3c6e:	4505                	li	a0,1
    ...
    3c7e:	b5e50513          	addi	a0,a0,-1186 # 77d8 <malloc+0x1812>
    3c82:	00002097          	auipc	ra,0x2
    3c86:	28c080e7          	jalr	652(ra) # 5f0e <printf>
    exit(1);
    3c8a:	4505                	li	a0,1
    ...
    3c9a:	b6a50513          	addi	a0,a0,-1174 # 7800 <malloc+0x183a>
    3c9e:	00002097          	auipc	ra,0x2
    3ca2:	270080e7          	jalr	624(ra) # 5f0e <printf>
    exit(1);
    3ca6:	4505                	li	a0,1
    ...
    3cb6:	b7650513          	addi	a0,a0,-1162 # 7828 <malloc+0x1862>
    3cba:	00002097          	auipc	ra,0x2
    3cbe:	254080e7          	jalr	596(ra) # 5f0e <printf>
    exit(1);
    3cc2:	4505                	li	a0,1
    ...
    3cd2:	b7a50513          	addi	a0,a0,-1158 # 7848 <malloc+0x1882>
    3cd6:	00002097          	auipc	ra,0x2
    3cda:	238080e7          	jalr	568(ra) # 5f0e <printf>
    exit(1);
    3cde:	4505                	li	a0,1
    ...
    3cee:	b7e50513          	addi	a0,a0,-1154 # 7868 <malloc+0x18a2>
    3cf2:	00002097          	auipc	ra,0x2
    3cf6:	21c080e7          	jalr	540(ra) # 5f0e <printf>
    exit(1);
    3cfa:	4505                	li	a0,1
    ...
    3d0a:	b8a50513          	addi	a0,a0,-1142 # 7890 <malloc+0x18ca>
    3d0e:	00002097          	auipc	ra,0x2
    3d12:	200080e7          	jalr	512(ra) # 5f0e <printf>
    exit(1);
    3d16:	4505                	li	a0,1
    ...
    3d26:	b8e50513          	addi	a0,a0,-1138 # 78b0 <malloc+0x18ea>
    3d2a:	00002097          	auipc	ra,0x2
    3d2e:	1e4080e7          	jalr	484(ra) # 5f0e <printf>
    exit(1);
    3d32:	4505                	li	a0,1
    ...
    3d42:	b9250513          	addi	a0,a0,-1134 # 78d0 <malloc+0x190a>
    3d46:	00002097          	auipc	ra,0x2
    3d4a:	1c8080e7          	jalr	456(ra) # 5f0e <printf>
    exit(1);
    3d4e:	4505                	li	a0,1
    ...
    3d5e:	b9e50513          	addi	a0,a0,-1122 # 78f8 <malloc+0x1932>
    3d62:	00002097          	auipc	ra,0x2
    3d66:	1ac080e7          	jalr	428(ra) # 5f0e <printf>
    exit(1);
    3d6a:	4505                	li	a0,1
    ...
    3d7a:	81a50513          	addi	a0,a0,-2022 # 7590 <malloc+0x15ca>
    3d7e:	00002097          	auipc	ra,0x2
    3d82:	190080e7          	jalr	400(ra) # 5f0e <printf>
    exit(1);
    3d86:	4505                	li	a0,1
    ...
    3d96:	b8650513          	addi	a0,a0,-1146 # 7918 <malloc+0x1952>
    3d9a:	00002097          	auipc	ra,0x2
    3d9e:	174080e7          	jalr	372(ra) # 5f0e <printf>
    exit(1);
    3da2:	4505                	li	a0,1
    ...
    3db2:	b8a50513          	addi	a0,a0,-1142 # 7938 <malloc+0x1972>
    3db6:	00002097          	auipc	ra,0x2
    3dba:	158080e7          	jalr	344(ra) # 5f0e <printf>
    exit(1);
    3dbe:	4505                	li	a0,1
    ...
    3dce:	b9e50513          	addi	a0,a0,-1122 # 7968 <malloc+0x19a2>
    3dd2:	00002097          	auipc	ra,0x2
    3dd6:	13c080e7          	jalr	316(ra) # 5f0e <printf>
    exit(1);
    3dda:	4505                	li	a0,1
    ...
    3dea:	ba250513          	addi	a0,a0,-1118 # 7988 <malloc+0x19c2>
    3dee:	00002097          	auipc	ra,0x2
    3df2:	120080e7          	jalr	288(ra) # 5f0e <printf>
    exit(1);
    3df6:	4505                	li	a0,1
...
0000000000003e00 <rmdot>:
{
  ...
  if (mkdir("dots") != 0)
    ...
    3e10:	b9450513          	addi	a0,a0,-1132 # 79a0 <malloc+0x19da>
  ...
  if (chdir("dots") != 0)
    ...
    3e22:	b8250513          	addi	a0,a0,-1150 # 79a0 <malloc+0x19da>
  ...
  if (unlink(".") == 0)
    ...
    3e34:	9a050513          	addi	a0,a0,-1632 # 67d0 <malloc+0x80a>
  ...
  if (unlink("..") == 0)
    ...
    3e46:	5b650513          	addi	a0,a0,1462 # 73f8 <malloc+0x1432>
  ...
  if (chdir("/") != 0)
    ...
    3e58:	54c50513          	addi	a0,a0,1356 # 73a0 <malloc+0x13da>
  ...
  if (unlink("dots/.") == 0)
    ...
    3e6a:	ba250513          	addi	a0,a0,-1118 # 7a08 <malloc+0x1a42>
  ...
  if (unlink("dots/..") == 0)
    ...
    3e7c:	bb850513          	addi	a0,a0,-1096 # 7a30 <malloc+0x1a6a>
  ...
  if (unlink("dots") != 0)
    ...
    3e8e:	b1650513          	addi	a0,a0,-1258 # 79a0 <malloc+0x19da>
    ...
    3eac:	b0050513          	addi	a0,a0,-1280 # 79a8 <malloc+0x19e2>
    3eb0:	00002097          	auipc	ra,0x2
    3eb4:	05e080e7          	jalr	94(ra) # 5f0e <printf>
    exit(1);
    3eb8:	4505                	li	a0,1
    ...
    3ec8:	afc50513          	addi	a0,a0,-1284 # 79c0 <malloc+0x19fa>
    3ecc:	00002097          	auipc	ra,0x2
    3ed0:	042080e7          	jalr	66(ra) # 5f0e <printf>
    exit(1);
    3ed4:	4505                	li	a0,1
    ...
    3ee4:	af850513          	addi	a0,a0,-1288 # 79d8 <malloc+0x1a12>
    3ee8:	00002097          	auipc	ra,0x2
    3eec:	026080e7          	jalr	38(ra) # 5f0e <printf>
    exit(1);
    3ef0:	4505                	li	a0,1
    ...
    3f00:	af450513          	addi	a0,a0,-1292 # 79f0 <malloc+0x1a2a>
    3f04:	00002097          	auipc	ra,0x2
    3f08:	00a080e7          	jalr	10(ra) # 5f0e <printf>
    exit(1);
    3f0c:	4505                	li	a0,1
    ...
    3f1c:	49050513          	addi	a0,a0,1168 # 73a8 <malloc+0x13e2>
    3f20:	00002097          	auipc	ra,0x2
    3f24:	fee080e7          	jalr	-18(ra) # 5f0e <printf>
    exit(1);
    3f28:	4505                	li	a0,1
    ...
    3f38:	adc50513          	addi	a0,a0,-1316 # 7a10 <malloc+0x1a4a>
    3f3c:	00002097          	auipc	ra,0x2
    3f40:	fd2080e7          	jalr	-46(ra) # 5f0e <printf>
    exit(1);
    3f44:	4505                	li	a0,1
    ...
    3f54:	ae850513          	addi	a0,a0,-1304 # 7a38 <malloc+0x1a72>
    3f58:	00002097          	auipc	ra,0x2
    3f5c:	fb6080e7          	jalr	-74(ra) # 5f0e <printf>
    exit(1);
    3f60:	4505                	li	a0,1
    ...
    3f70:	aec50513          	addi	a0,a0,-1300 # 7a58 <malloc+0x1a92>
    3f74:	00002097          	auipc	ra,0x2
    3f78:	f9a080e7          	jalr	-102(ra) # 5f0e <printf>
    exit(1);
    3f7c:	4505                	li	a0,1
...
0000000000003f86 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3f9c:	ae050513          	addi	a0,a0,-1312 # 7a78 <malloc+0x1ab2>
  ...
  if (chdir("dirfile") == 0)
    ...
    3fb8:	ac450513          	addi	a0,a0,-1340 # 7a78 <malloc+0x1ab2>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3fcc:	af850513          	addi	a0,a0,-1288 # 7ac0 <malloc+0x1afa>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3fe4:	ae050513          	addi	a0,a0,-1312 # 7ac0 <malloc+0x1afa>
  ...
  if (mkdir("dirfile/xx") == 0)
    ...
    3ff8:	acc50513          	addi	a0,a0,-1332 # 7ac0 <malloc+0x1afa>
  ...
  if (unlink("dirfile/xx") == 0)
    ...
    400c:	ab850513          	addi	a0,a0,-1352 # 7ac0 <malloc+0x1afa>
  ...
  if (link("README", "dirfile/xx") == 0)
    ...
    4020:	aa458593          	addi	a1,a1,-1372 # 7ac0 <malloc+0x1afa>
    4024:	00002517          	auipc	a0,0x2
    4028:	29c50513          	addi	a0,a0,668 # 62c0 <malloc+0x2fa>
  ...
  if (unlink("dirfile") != 0)
    ...
    403c:	a4050513          	addi	a0,a0,-1472 # 7a78 <malloc+0x1ab2>
  ...
  fd = open(".", O_RDWR);
    ...
    4052:	78250513          	addi	a0,a0,1922 # 67d0 <malloc+0x80a>
  ...
  fd = open(".", 0);
    ...
    4068:	76c50513          	addi	a0,a0,1900 # 67d0 <malloc+0x80a>
  ...
  if (write(fd, "x", 1) > 0)
    ...
    407c:	0e058593          	addi	a1,a1,224 # 6158 <malloc+0x192>
  ...
  close(fd);
    ...
    40a8:	9dc50513          	addi	a0,a0,-1572 # 7a80 <malloc+0x1aba>
    40ac:	00002097          	auipc	ra,0x2
    40b0:	e62080e7          	jalr	-414(ra) # 5f0e <printf>
    exit(1);
    40b4:	4505                	li	a0,1
    ...
    40c4:	9e050513          	addi	a0,a0,-1568 # 7aa0 <malloc+0x1ada>
    40c8:	00002097          	auipc	ra,0x2
    40cc:	e46080e7          	jalr	-442(ra) # 5f0e <printf>
    exit(1);
    40d0:	4505                	li	a0,1
    ...
    40e0:	9f450513          	addi	a0,a0,-1548 # 7ad0 <malloc+0x1b0a>
    40e4:	00002097          	auipc	ra,0x2
    40e8:	e2a080e7          	jalr	-470(ra) # 5f0e <printf>
    exit(1);
    40ec:	4505                	li	a0,1
    ...
    40fc:	9d850513          	addi	a0,a0,-1576 # 7ad0 <malloc+0x1b0a>
    4100:	00002097          	auipc	ra,0x2
    4104:	e0e080e7          	jalr	-498(ra) # 5f0e <printf>
    exit(1);
    4108:	4505                	li	a0,1
    ...
    4118:	9e450513          	addi	a0,a0,-1564 # 7af8 <malloc+0x1b32>
    411c:	00002097          	auipc	ra,0x2
    4120:	df2080e7          	jalr	-526(ra) # 5f0e <printf>
    exit(1);
    4124:	4505                	li	a0,1
    ...
    4134:	9f050513          	addi	a0,a0,-1552 # 7b20 <malloc+0x1b5a>
    4138:	00002097          	auipc	ra,0x2
    413c:	dd6080e7          	jalr	-554(ra) # 5f0e <printf>
    exit(1);
    4140:	4505                	li	a0,1
    ...
    4150:	9fc50513          	addi	a0,a0,-1540 # 7b48 <malloc+0x1b82>
    4154:	00002097          	auipc	ra,0x2
    4158:	dba080e7          	jalr	-582(ra) # 5f0e <printf>
    exit(1);
    415c:	4505                	li	a0,1
    ...
    416c:	a0850513          	addi	a0,a0,-1528 # 7b70 <malloc+0x1baa>
    4170:	00002097          	auipc	ra,0x2
    4174:	d9e080e7          	jalr	-610(ra) # 5f0e <printf>
    exit(1);
    4178:	4505                	li	a0,1
    ...
    4188:	a0c50513          	addi	a0,a0,-1524 # 7b90 <malloc+0x1bca>
    418c:	00002097          	auipc	ra,0x2
    4190:	d82080e7          	jalr	-638(ra) # 5f0e <printf>
    exit(1);
    4194:	4505                	li	a0,1
    ...
    41a4:	a1850513          	addi	a0,a0,-1512 # 7bb8 <malloc+0x1bf2>
    41a8:	00002097          	auipc	ra,0x2
    41ac:	d66080e7          	jalr	-666(ra) # 5f0e <printf>
    exit(1);
    41b0:	4505                	li	a0,1
...
00000000000041ba <iref>:
{
    ...
    41d8:	9fca0a13          	addi	s4,s4,-1540 # 7bd0 <malloc+0x1c0a>
    mkdir("");
    41dc:	00003497          	auipc	s1,0x3
    41e0:	4fc48493          	addi	s1,s1,1276 # 76d8 <malloc+0x1712>
    link("README", "");
    41e4:	00002a97          	auipc	s5,0x2
    41e8:	0dca8a93          	addi	s5,s5,220 # 62c0 <malloc+0x2fa>
    fd = open("xx", O_CREATE);
    41ec:	00004997          	auipc	s3,0x4
    41f0:	8dc98993          	addi	s3,s3,-1828 # 7ac8 <malloc+0x1b02>
    41f4:	a891                	j	4248 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    41f6:	85da                	mv	a1,s6
    41f8:	00004517          	auipc	a0,0x4
    41fc:	9e050513          	addi	a0,a0,-1568 # 7bd8 <malloc+0x1c12>
    ...
    4218:	9dc50513          	addi	a0,a0,-1572 # 7bf0 <malloc+0x1c2a>
  ...
  for (i = 0; i < NINODE + 1; i++)
    ...
    42ac:	15098993          	addi	s3,s3,336 # 73f8 <malloc+0x1432>
    unlink("irefd");
    42b0:	00004917          	auipc	s2,0x4
    42b4:	92090913          	addi	s2,s2,-1760 # 7bd0 <malloc+0x1c0a>
    chdir("..");
    42b8:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    42d4:	0d050513          	addi	a0,a0,208 # 73a0 <malloc+0x13da>
...
00000000000042f4 <openiputtest>:
{
  ...
  if (mkdir("oidir") < 0)
    ...
    4304:	90850513          	addi	a0,a0,-1784 # 7c08 <malloc+0x1c42>
  ...
  if (pid == 0)
    ...
    4328:	8e450513          	addi	a0,a0,-1820 # 7c08 <malloc+0x1c42>
    ...
    433e:	8ee50513          	addi	a0,a0,-1810 # 7c28 <malloc+0x1c62>
    4342:	00002097          	auipc	ra,0x2
    4346:	bcc080e7          	jalr	-1076(ra) # 5f0e <printf>
      exit(1);
    434a:	4505                	li	a0,1
    ...
    435a:	8ba50513          	addi	a0,a0,-1862 # 7c10 <malloc+0x1c4a>
    435e:	00002097          	auipc	ra,0x2
    4362:	bb0080e7          	jalr	-1104(ra) # 5f0e <printf>
    exit(1);
    4366:	4505                	li	a0,1
    ...
    4376:	5fe50513          	addi	a0,a0,1534 # 6970 <malloc+0x9aa>
    437a:	00002097          	auipc	ra,0x2
    437e:	b94080e7          	jalr	-1132(ra) # 5f0e <printf>
    exit(1);
    4382:	4505                	li	a0,1
  ...
  if (unlink("oidir") != 0)
    ...
    43a4:	86850513          	addi	a0,a0,-1944 # 7c08 <malloc+0x1c42>
    ...
    43b8:	7ac50513          	addi	a0,a0,1964 # 6b60 <malloc+0xb9a>
    43bc:	00002097          	auipc	ra,0x2
    43c0:	b52080e7          	jalr	-1198(ra) # 5f0e <printf>
    exit(1);
    43c4:	4505                	li	a0,1
...
00000000000043e6 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    43f6:	85e50513          	addi	a0,a0,-1954 # 7c50 <malloc+0x1c8a>
  ...
  close(open("stopforking", O_CREATE | O_RDWR));
    ...
    4422:	83250513          	addi	a0,a0,-1998 # 7c50 <malloc+0x1c8a>
  ...
  sleep(10); // one second
    ...
    445a:	6da50513          	addi	a0,a0,1754 # 6b30 <malloc+0xb6a>
    445e:	00002097          	auipc	ra,0x2
    4462:	ab0080e7          	jalr	-1360(ra) # 5f0e <printf>
    exit(1);
    4466:	4505                	li	a0,1
    ...
    4474:	7e048493          	addi	s1,s1,2016 # 7c50 <malloc+0x1c8a>
    4478:	4581                	li	a1,0
    447a:	8526                	mv	a0,s1
...
00000000000044b6 <killstatus>:
{
  ...
  exit(0);
    ...
    451c:	45850513          	addi	a0,a0,1112 # 6970 <malloc+0x9aa>
    4520:	00002097          	auipc	ra,0x2
    4524:	9ee080e7          	jalr	-1554(ra) # 5f0e <printf>
      exit(1);
    4528:	4505                	li	a0,1
    ...
    4542:	72250513          	addi	a0,a0,1826 # 7c60 <malloc+0x1c9a>
    4546:	00002097          	auipc	ra,0x2
    454a:	9c8080e7          	jalr	-1592(ra) # 5f0e <printf>
      exit(1);
    454e:	4505                	li	a0,1
...
0000000000004558 <preempt>:
{
  ...
  if (pid1 == 0)
    ...
    4582:	5b250513          	addi	a0,a0,1458 # 6b30 <malloc+0xb6a>
    4586:	00002097          	auipc	ra,0x2
    458a:	988080e7          	jalr	-1656(ra) # 5f0e <printf>
    exit(1);
    458e:	4505                	li	a0,1
  ...
  if (pid2 == 0)
    ...
    45b0:	3c450513          	addi	a0,a0,964 # 6970 <malloc+0x9aa>
    45b4:	00002097          	auipc	ra,0x2
    45b8:	95a080e7          	jalr	-1702(ra) # 5f0e <printf>
    exit(1);
    45bc:	4505                	li	a0,1
  ...
  if (pid3 == 0)
    ...
    45f4:	b6858593          	addi	a1,a1,-1176 # 6158 <malloc+0x192>
    ...
    461e:	35650513          	addi	a0,a0,854 # 6970 <malloc+0x9aa>
    4622:	00002097          	auipc	ra,0x2
    4626:	8ec080e7          	jalr	-1812(ra) # 5f0e <printf>
    exit(1);
    462a:	4505                	li	a0,1
    ...
    463a:	64a50513          	addi	a0,a0,1610 # 7c80 <malloc+0x1cba>
    463e:	00002097          	auipc	ra,0x2
    4642:	8d0080e7          	jalr	-1840(ra) # 5f0e <printf>
  ...
  if (read(pfds[0], buf, sizeof(buf)) != 1)
    ...
    4676:	62650513          	addi	a0,a0,1574 # 7c98 <malloc+0x1cd2>
    467a:	00002097          	auipc	ra,0x2
    467e:	894080e7          	jalr	-1900(ra) # 5f0e <printf>
}
  ...
  printf("kill... ");
    ...
    46a2:	61250513          	addi	a0,a0,1554 # 7cb0 <malloc+0x1cea>
    46a6:	00002097          	auipc	ra,0x2
    46aa:	868080e7          	jalr	-1944(ra) # 5f0e <printf>
  kill(pid1);
    46ae:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    46d0:	5f450513          	addi	a0,a0,1524 # 7cc0 <malloc+0x1cfa>
    46d4:	00002097          	auipc	ra,0x2
    46d8:	83a080e7          	jalr	-1990(ra) # 5f0e <printf>
  wait(0);
    46dc:	4501                	li	a0,0
...
00000000000046fc <reparent>:
{
  ...
  exit(0);
    ...
    4750:	22450513          	addi	a0,a0,548 # 6970 <malloc+0x9aa>
    4754:	00001097          	auipc	ra,0x1
    4758:	7ba080e7          	jalr	1978(ra) # 5f0e <printf>
      exit(1);
    475c:	4505                	li	a0,1
    ...
    476c:	39050513          	addi	a0,a0,912 # 6af8 <malloc+0xb32>
    4770:	00001097          	auipc	ra,0x1
    4774:	79e080e7          	jalr	1950(ra) # 5f0e <printf>
        exit(1);
    4778:	4505                	li	a0,1
...
00000000000047ac <sbrkfail>:
{
  ...
  if (pipe(fds) != 0)
    ...
    47e2:	29a50513          	addi	a0,a0,666 # 6a78 <malloc+0xab2>
    47e6:	00001097          	auipc	ra,0x1
    47ea:	728080e7          	jalr	1832(ra) # 5f0e <printf>
    exit(1);
    47ee:	4505                	li	a0,1
    ...
    4816:	94658593          	addi	a1,a1,-1722 # 6158 <malloc+0x192>
  ...
  if (xstatus != -1 && xstatus != 2)
    ...
    48da:	3fa50513          	addi	a0,a0,1018 # 7cd0 <malloc+0x1d0a>
    48de:	00001097          	auipc	ra,0x1
    48e2:	630080e7          	jalr	1584(ra) # 5f0e <printf>
    exit(1);
    48e6:	4505                	li	a0,1
    ...
    48f6:	07e50513          	addi	a0,a0,126 # 6970 <malloc+0x9aa>
    48fa:	00001097          	auipc	ra,0x1
    48fe:	614080e7          	jalr	1556(ra) # 5f0e <printf>
    exit(1);
    4902:	4505                	li	a0,1
    ...
    4942:	3b250513          	addi	a0,a0,946 # 7cf0 <malloc+0x1d2a>
    4946:	00001097          	auipc	ra,0x1
    494a:	5c8080e7          	jalr	1480(ra) # 5f0e <printf>
    exit(1);
    494e:	4505                	li	a0,1
...
0000000000004962 <mem>:
{
  ...
  if ((pid = fork()) == 0)
    ...
    49ac:	61e080e7          	jalr	1566(ra) # 5fc6 <malloc>
    ...
    49e6:	33e50513          	addi	a0,a0,830 # 7d20 <malloc+0x1d5a>
    49ea:	00001097          	auipc	ra,0x1
    49ee:	524080e7          	jalr	1316(ra) # 5f0e <printf>
      exit(1);
    49f2:	4505                	li	a0,1
...
0000000000004a06 <sharedfd>:
{
  ...
  if (pid == 0)
    ...
    4aa4:	46e080e7          	jalr	1134(ra) # 5f0e <printf>
    exit(1);
    4aa8:	4505                	li	a0,1
    ...
    4ab8:	2c450513          	addi	a0,a0,708 # 7d78 <malloc+0x1db2>
    4abc:	00001097          	auipc	ra,0x1
    4ac0:	452080e7          	jalr	1106(ra) # 5f0e <printf>
      exit(1);
    4ac4:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    4afc:	24850513          	addi	a0,a0,584 # 7d40 <malloc+0x1d7a>
  ...
  while ((n = read(fd, buf, sizeof(buf))) > 0)
    ...
    4b3c:	26050513          	addi	a0,a0,608 # 7d98 <malloc+0x1dd2>
    4b40:	00001097          	auipc	ra,0x1
    4b44:	3ce080e7          	jalr	974(ra) # 5f0e <printf>
    exit(1);
    4b48:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4b78:	1cc50513          	addi	a0,a0,460 # 7d40 <malloc+0x1d7a>
  ...
  if (nc == N * SZ && np == N * SZ)
    ...
    4b9e:	22650513          	addi	a0,a0,550 # 7dc0 <malloc+0x1dfa>
...
0000000000004bbe <fourfiles>:
{
  ...
  char *names[] = {"f0", "f1", "f2", "f3"};
    ...
    4be4:	1f878793          	addi	a5,a5,504 # 7dd8 <malloc+0x1e12>
    4be8:	f6f43823          	sd	a5,-144(s0)
    4bec:	00003797          	auipc	a5,0x3
    4bf0:	1f478793          	addi	a5,a5,500 # 7de0 <malloc+0x1e1a>
    4bf4:	f6f43c23          	sd	a5,-136(s0)
    4bf8:	00003797          	auipc	a5,0x3
    4bfc:	1f078793          	addi	a5,a5,496 # 7de8 <malloc+0x1e22>
    4c00:	f8f43023          	sd	a5,-128(s0)
    4c04:	00003797          	auipc	a5,0x3
    4c08:	1ec78793          	addi	a5,a5,492 # 7df0 <malloc+0x1e2a>
  ...
  for (i = 0; i < NCHILD; i++)
    ...
    4c80:	0fc50513          	addi	a0,a0,252 # 6d78 <malloc+0xdb2>
    4c84:	00001097          	auipc	ra,0x1
    4c88:	28a080e7          	jalr	650(ra) # 5f0e <printf>
      exit(1);
    4c8c:	4505                	li	a0,1
    ...
    4cfc:	10050513          	addi	a0,a0,256 # 7df8 <malloc+0x1e32>
    4d00:	00001097          	auipc	ra,0x1
    4d04:	20e080e7          	jalr	526(ra) # 5f0e <printf>
        exit(1);
    4d08:	4505                	li	a0,1
    ...
    4d16:	0f650513          	addi	a0,a0,246 # 7e08 <malloc+0x1e42>
    4d1a:	00001097          	auipc	ra,0x1
    4d1e:	1f4080e7          	jalr	500(ra) # 5f0e <printf>
          exit(1);
    4d22:	4505                	li	a0,1
    ...
    4d3e:	0e650513          	addi	a0,a0,230 # 7e20 <malloc+0x1e5a>
    4d42:	00001097          	auipc	ra,0x1
    4d46:	1cc080e7          	jalr	460(ra) # 5f0e <printf>
          exit(1);
    4d4a:	4505                	li	a0,1
  ...
  for (i = 0; i < NCHILD; i++)
    ...
    4dcc:	06850513          	addi	a0,a0,104 # 7e30 <malloc+0x1e6a>
    4dd0:	00001097          	auipc	ra,0x1
    4dd4:	13e080e7          	jalr	318(ra) # 5f0e <printf>
      exit(1);
    4dd8:	4505                	li	a0,1
...
0000000000004e00 <concreate>:
{
  ...
  for (i = 0; i < N; i++)
    ...
    4e2e:	01eb8b93          	addi	s7,s7,30 # 7e48 <malloc+0x1e82>
  for (i = 0; i < N; i++)
    ...
    4e70:	fe450513          	addi	a0,a0,-28 # 7e50 <malloc+0x1e8a>
    4e74:	00001097          	auipc	ra,0x1
    4e78:	09a080e7          	jalr	154(ra) # 5f0e <printf>
        exit(1);
    4e7c:	4505                	li	a0,1
    ...
    4e8e:	fbe50513          	addi	a0,a0,-66 # 7e48 <malloc+0x1e82>
  ...
  fd = open(".", 0);
    ...
    4ec6:	90e50513          	addi	a0,a0,-1778 # 67d0 <malloc+0x80a>
  ...
  while (read(fd, &de, sizeof(de)) > 0)
    ...
    4f3e:	f3650513          	addi	a0,a0,-202 # 7e70 <malloc+0x1eaa>
    4f42:	00001097          	auipc	ra,0x1
    4f46:	fcc080e7          	jalr	-52(ra) # 5f0e <printf>
        exit(1);
    4f4a:	4505                	li	a0,1
    ...
    4f5e:	f3650513          	addi	a0,a0,-202 # 7e90 <malloc+0x1eca>
    4f62:	00001097          	auipc	ra,0x1
    4f66:	fac080e7          	jalr	-84(ra) # 5f0e <printf>
        exit(1);
    4f6a:	4505                	li	a0,1
  ...
  for (i = 0; i < N; i++)
    ...
    4f96:	f2650513          	addi	a0,a0,-218 # 7eb8 <malloc+0x1ef2>
    4f9a:	00001097          	auipc	ra,0x1
    4f9e:	f74080e7          	jalr	-140(ra) # 5f0e <printf>
    exit(1);
    4fa2:	4505                	li	a0,1
    ...
    4fb2:	9c250513          	addi	a0,a0,-1598 # 6970 <malloc+0x9aa>
    4fb6:	00001097          	auipc	ra,0x1
    4fba:	f58080e7          	jalr	-168(ra) # 5f0e <printf>
      exit(1);
    4fbe:	4505                	li	a0,1
...
000000000000515c <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    51e4:	d1050513          	addi	a0,a0,-752 # 7ef0 <malloc+0x1f2a>
  ...
  for (i = 0;; i++)
    ...
    5250:	cc2080e7          	jalr	-830(ra) # 5f0e <printf>
    exit(1);
    5254:	4505                	li	a0,1
    ...
    5264:	cc050513          	addi	a0,a0,-832 # 7f20 <malloc+0x1f5a>
    5268:	00001097          	auipc	ra,0x1
    526c:	ca6080e7          	jalr	-858(ra) # 5f0e <printf>
      exit(1);
    5270:	4505                	li	a0,1
    ...
    5280:	cc450513          	addi	a0,a0,-828 # 7f40 <malloc+0x1f7a>
    5284:	00001097          	auipc	ra,0x1
    5288:	c8a080e7          	jalr	-886(ra) # 5f0e <printf>
    exit(1);
    528c:	4505                	li	a0,1
    ...
    529c:	cc850513          	addi	a0,a0,-824 # 7f60 <malloc+0x1f9a>
    52a0:	00001097          	auipc	ra,0x1
    52a4:	c6e080e7          	jalr	-914(ra) # 5f0e <printf>
      exit(1);
    52a8:	4505                	li	a0,1
    ...
    52b8:	ccc50513          	addi	a0,a0,-820 # 7f80 <malloc+0x1fba>
    52bc:	00001097          	auipc	ra,0x1
    52c0:	c52080e7          	jalr	-942(ra) # 5f0e <printf>
      exit(1);
    52c4:	4505                	li	a0,1
    ...
    52d4:	cc850513          	addi	a0,a0,-824 # 7f98 <malloc+0x1fd2>
    52d8:	00001097          	auipc	ra,0x1
    52dc:	c36080e7          	jalr	-970(ra) # 5f0e <printf>
      exit(1);
    52e0:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    5302:	bf250513          	addi	a0,a0,-1038 # 7ef0 <malloc+0x1f2a>
    ...
    5326:	c9650513          	addi	a0,a0,-874 # 7fb8 <malloc+0x1ff2>
    532a:	00001097          	auipc	ra,0x1
    532e:	be4080e7          	jalr	-1052(ra) # 5f0e <printf>
    exit(1);
    5332:	4505                	li	a0,1
...
000000000000533c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    535e:	c7e50513          	addi	a0,a0,-898 # 7fd8 <malloc+0x2012>
    5362:	00001097          	auipc	ra,0x1
    5366:	bac080e7          	jalr	-1108(ra) # 5f0e <printf>
  for (nfiles = 0;; nfiles++)
    536a:	4481                	li	s1,0
    name[0] = 'f';
    ...
    537e:	c6ec8c93          	addi	s9,s9,-914 # 7fe8 <malloc+0x2022>
    int total = 0;
    5382:	4d81                	li	s11,0
    ...
    53d6:	b3c080e7          	jalr	-1220(ra) # 5f0e <printf>
    int fd = open(name, O_CREATE | O_RDWR);
    ...
    53f8:	c0450513          	addi	a0,a0,-1020 # 7ff8 <malloc+0x2032>
    53fc:	00001097          	auipc	ra,0x1
    5400:	b12080e7          	jalr	-1262(ra) # 5f0e <printf>
  while (nfiles >= 0)
  ...
  printf("fsfull test finished\n");
    ...
    546e:	bae50513          	addi	a0,a0,-1106 # 8018 <malloc+0x2052>
    5472:	00001097          	auipc	ra,0x1
    5476:	a9c080e7          	jalr	-1380(ra) # 5f0e <printf>
}
    ...
    54be:	b4e50513          	addi	a0,a0,-1202 # 8008 <malloc+0x2042>
    54c2:	00001097          	auipc	ra,0x1
    54c6:	a4c080e7          	jalr	-1460(ra) # 5f0e <printf>
    close(fd);
    54ca:	854a                	mv	a0,s2
...
int run(void f(char *), char *s)
{
  ...
  printf("test %s: ", s);
    ...
    54f0:	b4450513          	addi	a0,a0,-1212 # 8030 <malloc+0x206a>
    54f4:	00001097          	auipc	ra,0x1
    54f8:	a1a080e7          	jalr	-1510(ra) # 5f0e <printf>
  if ((pid = fork()) < 0)
  ...
  else
  {
    ...
    5520:	b3c50513          	addi	a0,a0,-1220 # 8058 <malloc+0x2092>
    5524:	00001097          	auipc	ra,0x1
    5528:	9ea080e7          	jalr	-1558(ra) # 5f0e <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5544:	b0050513          	addi	a0,a0,-1280 # 8040 <malloc+0x207a>
    5548:	00001097          	auipc	ra,0x1
    554c:	9c6080e7          	jalr	-1594(ra) # 5f0e <printf>
    exit(1);
    5550:	4505                	li	a0,1
    ...
    556c:	af850513          	addi	a0,a0,-1288 # 8060 <malloc+0x209a>
    5570:	00001097          	auipc	ra,0x1
    5574:	99e080e7          	jalr	-1634(ra) # 5f0e <printf>
...
int runtests(struct test *tests, char *justone)
{
  ...
  for (struct test *t = tests; t->s != 0; t++)
    ...
    55bc:	ab050513          	addi	a0,a0,-1360 # 8068 <malloc+0x20a2>
    55c0:	00001097          	auipc	ra,0x1
    55c4:	94e080e7          	jalr	-1714(ra) # 5f0e <printf>
        return 1;
    55c8:	4505                	li	a0,1
}
...
int countfree()
{
    ...
    5600:	ed51                	bnez	a0,569c <countfree+0xc6>
  {
    ...
    5616:	b4698993          	addi	s3,s3,-1210 # 6158 <malloc+0x192>
      uint64 a = (uint64)sbrk(4096);
    ...
    5648:	a7c50513          	addi	a0,a0,-1412 # 80c0 <malloc+0x20fa>
    564c:	00001097          	auipc	ra,0x1
    5650:	8c2080e7          	jalr	-1854(ra) # 5f0e <printf>
        exit(1);
    5654:	4505                	li	a0,1
    ...
    5662:	a2250513          	addi	a0,a0,-1502 # 8080 <malloc+0x20ba>
    5666:	00001097          	auipc	ra,0x1
    566a:	8a8080e7          	jalr	-1880(ra) # 5f0e <printf>
    exit(1);
    566e:	4505                	li	a0,1
    ...
    567c:	a2850513          	addi	a0,a0,-1496 # 80a0 <malloc+0x20da>
    5680:	00001097          	auipc	ra,0x1
    5684:	88e080e7          	jalr	-1906(ra) # 5f0e <printf>
    exit(1);
    5688:	4505                	li	a0,1
    ...
    56c2:	2485                	addiw	s1,s1,1
  {
    ...
    56ca:	a1a50513          	addi	a0,a0,-1510 # 80e0 <malloc+0x211a>
    56ce:	00001097          	auipc	ra,0x1
    56d2:	840080e7          	jalr	-1984(ra) # 5f0e <printf>
      exit(1);
    56d6:	4505                	li	a0,1
...
int drivetests(int quick, int continuous, char *justone)
{
  ...
  do
  {
    ...
    572c:	9d8b8b93          	addi	s7,s7,-1576 # 8100 <malloc+0x213a>
    int free0 = countfree();
    int free1 = 0;
    ...
    5776:	79c080e7          	jalr	1948(ra) # 5f0e <printf>
    int free0 = countfree();
    ...
    57c6:	74c080e7          	jalr	1868(ra) # 5f0e <printf>
      if (continuous != 2)
    ...
    57d6:	73c080e7          	jalr	1852(ra) # 5f0e <printf>
      if (continuous != 2)
...
int main(int argc, char *argv[])
{
  ...
  if (argc == 2 && strcmp(argv[1], "-q") == 0)
    ...
    5842:	92a58593          	addi	a1,a1,-1750 # 8168 <malloc+0x21a2>
    ...
    585a:	96a58593          	addi	a1,a1,-1686 # 81c0 <malloc+0x21fa>
    ...
    5870:	94c58593          	addi	a1,a1,-1716 # 81b8 <malloc+0x21f2>
  ...
  int continuous = 0;
    ...
    589c:	8d850513          	addi	a0,a0,-1832 # 8170 <malloc+0x21aa>
    58a0:	00000097          	auipc	ra,0x0
    58a4:	66e080e7          	jalr	1646(ra) # 5f0e <printf>
    exit(1);
    58a8:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    58c8:	8dc50513          	addi	a0,a0,-1828 # 81a0 <malloc+0x21da>
    58cc:	00000097          	auipc	ra,0x0
    58d0:	642080e7          	jalr	1602(ra) # 5f0e <printf>
  exit(0);
    58d4:	4501                	li	a0,0
...
putc(int fd, char c)
{
    5c34:	1101                	addi	sp,sp,-32
    5c36:	ec06                	sd	ra,24(sp)
    5c38:	e822                	sd	s0,16(sp)
    5c3a:	1000                	addi	s0,sp,32
    5c3c:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5c40:	4605                	li	a2,1
    5c42:	fef40593          	addi	a1,s0,-17
    5c46:	00000097          	auipc	ra,0x0
    5c4a:	f3e080e7          	jalr	-194(ra) # 5b84 <write>
}
    5c4e:	60e2                	ld	ra,24(sp)
    5c50:	6442                	ld	s0,16(sp)
    5c52:	6105                	addi	sp,sp,32
    5c54:	8082                	ret

0000000000005c56 <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    5c56:	7139                	addi	sp,sp,-64
    5c58:	fc06                	sd	ra,56(sp)
    5c5a:	f822                	sd	s0,48(sp)
    5c5c:	f426                	sd	s1,40(sp)
    5c5e:	f04a                	sd	s2,32(sp)
    5c60:	ec4e                	sd	s3,24(sp)
    5c62:	0080                	addi	s0,sp,64
    5c64:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if (sgn && xx < 0)
    5c66:	c299                	beqz	a3,5c6c <printint+0x16>
    5c68:	0805c963          	bltz	a1,5cfa <printint+0xa4>
    neg = 1;
    x = -xx;
  }
  else
  {
    x = xx;
    5c6c:	2581                	sext.w	a1,a1
  neg = 0;
    5c6e:	4881                	li	a7,0
    5c70:	fc040693          	addi	a3,s0,-64
  }
  ...
  {
    buf[i++] = digits[x % base];
    5c76:	2601                	sext.w	a2,a2
    5c78:	00003517          	auipc	a0,0x3
    5c7c:	91050513          	addi	a0,a0,-1776 # 8588 <digits>
    5c80:	883a                	mv	a6,a4
    5c82:	2705                	addiw	a4,a4,1
    5c84:	02c5f7bb          	remuw	a5,a1,a2
    5c88:	1782                	slli	a5,a5,0x20
    5c8a:	9381                	srli	a5,a5,0x20
    5c8c:	97aa                	add	a5,a5,a0
    5c8e:	0007c783          	lbu	a5,0(a5)
    5c92:	00f68023          	sb	a5,0(a3)
  } while ((x /= base) != 0);
    5c96:	0005879b          	sext.w	a5,a1
    5c9a:	02c5d5bb          	divuw	a1,a1,a2
    5c9e:	0685                	addi	a3,a3,1
    5ca0:	fec7f0e3          	bgeu	a5,a2,5c80 <printint+0x2a>
  if (neg)
    5ca4:	00088c63          	beqz	a7,5cbc <printint+0x66>
    buf[i++] = '-';
    5ca8:	fd070793          	addi	a5,a4,-48
    5cac:	00878733          	add	a4,a5,s0
    5cb0:	02d00793          	li	a5,45
    5cb4:	fef70823          	sb	a5,-16(a4)
    5cb8:	0028071b          	addiw	a4,a6,2

  while (--i >= 0)
    5cbc:	02e05863          	blez	a4,5cec <printint+0x96>
    5cc0:	fc040793          	addi	a5,s0,-64
    5cc4:	00e78933          	add	s2,a5,a4
    5cc8:	fff78993          	addi	s3,a5,-1
    5ccc:	99ba                	add	s3,s3,a4
    5cce:	377d                	addiw	a4,a4,-1
    5cd0:	1702                	slli	a4,a4,0x20
    5cd2:	9301                	srli	a4,a4,0x20
    5cd4:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5cd8:	fff94583          	lbu	a1,-1(s2)
    5cdc:	8526                	mv	a0,s1
    5cde:	00000097          	auipc	ra,0x0
    5ce2:	f56080e7          	jalr	-170(ra) # 5c34 <putc>
  while (--i >= 0)
    5ce6:	197d                	addi	s2,s2,-1
    5ce8:	ff3918e3          	bne	s2,s3,5cd8 <printint+0x82>
}
    5cec:	70e2                	ld	ra,56(sp)
    5cee:	7442                	ld	s0,48(sp)
    5cf0:	74a2                	ld	s1,40(sp)
    5cf2:	7902                	ld	s2,32(sp)
    5cf4:	69e2                	ld	s3,24(sp)
    5cf6:	6121                	addi	sp,sp,64
    5cf8:	8082                	ret
    x = -xx;
    5cfa:	40b005bb          	negw	a1,a1
    neg = 1;
    5cfe:	4885                	li	a7,1
    x = -xx;
    5d00:	bf85                	j	5c70 <printint+0x1a>

0000000000005d02 <vprintf>:
...
{
    5d02:	7119                	addi	sp,sp,-128
    5d04:	fc86                	sd	ra,120(sp)
    5d06:	f8a2                	sd	s0,112(sp)
    5d08:	f4a6                	sd	s1,104(sp)
    5d0a:	f0ca                	sd	s2,96(sp)
    5d0c:	ecce                	sd	s3,88(sp)
    5d0e:	e8d2                	sd	s4,80(sp)
    5d10:	e4d6                	sd	s5,72(sp)
    5d12:	e0da                	sd	s6,64(sp)
    5d14:	fc5e                	sd	s7,56(sp)
    5d16:	f862                	sd	s8,48(sp)
    5d18:	f466                	sd	s9,40(sp)
    5d1a:	f06a                	sd	s10,32(sp)
    5d1c:	ec6e                	sd	s11,24(sp)
    5d1e:	0100                	addi	s0,sp,128
  char *s;
  int c, i, state;
  ...
  for (i = 0; fmt[i]; i++)
    ...
    5d24:	18090f63          	beqz	s2,5ec2 <vprintf+0x1c0>
    5d28:	8aaa                	mv	s5,a0
    5d2a:	8b32                	mv	s6,a2
  ...
  state = 0;
    ...
    5d36:	4c55                	li	s8,21
    5d38:	00002c97          	auipc	s9,0x2
    5d3c:	7f8c8c93          	addi	s9,s9,2040 # 8530 <malloc+0x256a>
      else if (c == 's')
      {
        s = va_arg(ap, char *);
        if (s == 0)
          s = "(null)";
        while (*s != 0)
    5d40:	02800d93          	li	s11,40
  putc(fd, 'x');
    5d44:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5d46:	00003b97          	auipc	s7,0x3
    5d4a:	842b8b93          	addi	s7,s7,-1982 # 8588 <digits>
    5d4e:	a839                	j	5d6c <vprintf+0x6a>
        putc(fd, c);
    5d50:	85ca                	mv	a1,s2
    5d52:	8556                	mv	a0,s5
    5d54:	00000097          	auipc	ra,0x0
    5d58:	ee0080e7          	jalr	-288(ra) # 5c34 <putc>
    5d5c:	a019                	j	5d62 <vprintf+0x60>
    else if (state == '%')
    5d5e:	01498d63          	beq	s3,s4,5d78 <vprintf+0x76>
  for (i = 0; fmt[i]; i++)
    5d62:	0485                	addi	s1,s1,1
    5d64:	fff4c903          	lbu	s2,-1(s1)
    5d68:	14090d63          	beqz	s2,5ec2 <vprintf+0x1c0>
    if (state == 0)
    5d6c:	fe0999e3          	bnez	s3,5d5e <vprintf+0x5c>
      if (c == '%')
    5d70:	ff4910e3          	bne	s2,s4,5d50 <vprintf+0x4e>
        state = '%';
    5d74:	89d2                	mv	s3,s4
    5d76:	b7f5                	j	5d62 <vprintf+0x60>
      if (c == 'd')
    5d78:	11490c63          	beq	s2,s4,5e90 <vprintf+0x18e>
    5d7c:	f9d9079b          	addiw	a5,s2,-99
    5d80:	0ff7f793          	zext.b	a5,a5
    5d84:	10fc6e63          	bltu	s8,a5,5ea0 <vprintf+0x19e>
    5d88:	f9d9079b          	addiw	a5,s2,-99
    5d8c:	0ff7f713          	zext.b	a4,a5
    5d90:	10ec6863          	bltu	s8,a4,5ea0 <vprintf+0x19e>
    5d94:	00271793          	slli	a5,a4,0x2
    5d98:	97e6                	add	a5,a5,s9
    5d9a:	439c                	lw	a5,0(a5)
    5d9c:	97e6                	add	a5,a5,s9
    5d9e:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5da0:	008b0913          	addi	s2,s6,8
    5da4:	4685                	li	a3,1
    5da6:	4629                	li	a2,10
    5da8:	000b2583          	lw	a1,0(s6)
    5dac:	8556                	mv	a0,s5
    5dae:	00000097          	auipc	ra,0x0
    5db2:	ea8080e7          	jalr	-344(ra) # 5c56 <printint>
    5db6:	8b4a                	mv	s6,s2
      {
      ...
      state = 0;
    5db8:	4981                	li	s3,0
    5dba:	b765                	j	5d62 <vprintf+0x60>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5dbc:	008b0913          	addi	s2,s6,8
    5dc0:	4681                	li	a3,0
    5dc2:	4629                	li	a2,10
    5dc4:	000b2583          	lw	a1,0(s6)
    5dc8:	8556                	mv	a0,s5
    5dca:	00000097          	auipc	ra,0x0
    5dce:	e8c080e7          	jalr	-372(ra) # 5c56 <printint>
    5dd2:	8b4a                	mv	s6,s2
      state = 0;
    5dd4:	4981                	li	s3,0
    5dd6:	b771                	j	5d62 <vprintf+0x60>
    ...
    5dea:	e70080e7          	jalr	-400(ra) # 5c56 <printint>
    5dee:	8b4a                	mv	s6,s2
      state = 0;
    5df0:	4981                	li	s3,0
    5df2:	bf85                	j	5d62 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5df4:	008b0793          	addi	a5,s6,8
    5df8:	f8f43423          	sd	a5,-120(s0)
    5dfc:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5e00:	03000593          	li	a1,48
    5e04:	8556                	mv	a0,s5
    5e06:	00000097          	auipc	ra,0x0
    5e0a:	e2e080e7          	jalr	-466(ra) # 5c34 <putc>
  putc(fd, 'x');
    5e0e:	07800593          	li	a1,120
    5e12:	8556                	mv	a0,s5
    5e14:	00000097          	auipc	ra,0x0
    5e18:	e20080e7          	jalr	-480(ra) # 5c34 <putc>
    5e1c:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5e1e:	03c9d793          	srli	a5,s3,0x3c
    5e22:	97de                	add	a5,a5,s7
    5e24:	0007c583          	lbu	a1,0(a5)
    5e28:	8556                	mv	a0,s5
    5e2a:	00000097          	auipc	ra,0x0
    5e2e:	e0a080e7          	jalr	-502(ra) # 5c34 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5e32:	0992                	slli	s3,s3,0x4
    5e34:	397d                	addiw	s2,s2,-1
    5e36:	fe0914e3          	bnez	s2,5e1e <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5e3a:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5e3e:	4981                	li	s3,0
    5e40:	b70d                	j	5d62 <vprintf+0x60>
        s = va_arg(ap, char *);
    5e42:	008b0913          	addi	s2,s6,8
    5e46:	000b3983          	ld	s3,0(s6)
        if (s == 0)
    5e4a:	02098163          	beqz	s3,5e6c <vprintf+0x16a>
        while (*s != 0)
    5e4e:	0009c583          	lbu	a1,0(s3)
    5e52:	c5ad                	beqz	a1,5ebc <vprintf+0x1ba>
          putc(fd, *s);
    5e54:	8556                	mv	a0,s5
    5e56:	00000097          	auipc	ra,0x0
    5e5a:	dde080e7          	jalr	-546(ra) # 5c34 <putc>
          s++;
    5e5e:	0985                	addi	s3,s3,1
        while (*s != 0)
    5e60:	0009c583          	lbu	a1,0(s3)
    5e64:	f9e5                	bnez	a1,5e54 <vprintf+0x152>
        s = va_arg(ap, char *);
    5e66:	8b4a                	mv	s6,s2
      state = 0;
    5e68:	4981                	li	s3,0
    5e6a:	bde5                	j	5d62 <vprintf+0x60>
          s = "(null)";
    5e6c:	00002997          	auipc	s3,0x2
    5e70:	6bc98993          	addi	s3,s3,1724 # 8528 <malloc+0x2562>
        while (*s != 0)
    5e74:	85ee                	mv	a1,s11
    5e76:	bff9                	j	5e54 <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5e78:	008b0913          	addi	s2,s6,8
    5e7c:	000b4583          	lbu	a1,0(s6)
    5e80:	8556                	mv	a0,s5
    5e82:	00000097          	auipc	ra,0x0
    5e86:	db2080e7          	jalr	-590(ra) # 5c34 <putc>
    5e8a:	8b4a                	mv	s6,s2
      state = 0;
    5e8c:	4981                	li	s3,0
    5e8e:	bdd1                	j	5d62 <vprintf+0x60>
        putc(fd, c);
    5e90:	85d2                	mv	a1,s4
    5e92:	8556                	mv	a0,s5
    5e94:	00000097          	auipc	ra,0x0
    5e98:	da0080e7          	jalr	-608(ra) # 5c34 <putc>
      state = 0;
    5e9c:	4981                	li	s3,0
    5e9e:	b5d1                	j	5d62 <vprintf+0x60>
        putc(fd, '%');
    5ea0:	85d2                	mv	a1,s4
    5ea2:	8556                	mv	a0,s5
    5ea4:	00000097          	auipc	ra,0x0
    5ea8:	d90080e7          	jalr	-624(ra) # 5c34 <putc>
        putc(fd, c);
    5eac:	85ca                	mv	a1,s2
    5eae:	8556                	mv	a0,s5
    5eb0:	00000097          	auipc	ra,0x0
    5eb4:	d84080e7          	jalr	-636(ra) # 5c34 <putc>
      state = 0;
    5eb8:	4981                	li	s3,0
    5eba:	b565                	j	5d62 <vprintf+0x60>
        s = va_arg(ap, char *);
    5ebc:	8b4a                	mv	s6,s2
      state = 0;
    5ebe:	4981                	li	s3,0
    5ec0:	b54d                	j	5d62 <vprintf+0x60>
    }
  }
}
    5ec2:	70e6                	ld	ra,120(sp)
    5ec4:	7446                	ld	s0,112(sp)
    5ec6:	74a6                	ld	s1,104(sp)
    5ec8:	7906                	ld	s2,96(sp)
    5eca:	69e6                	ld	s3,88(sp)
    5ecc:	6a46                	ld	s4,80(sp)
    5ece:	6aa6                	ld	s5,72(sp)
    5ed0:	6b06                	ld	s6,64(sp)
    5ed2:	7be2                	ld	s7,56(sp)
    5ed4:	7c42                	ld	s8,48(sp)
    5ed6:	7ca2                	ld	s9,40(sp)
    5ed8:	7d02                	ld	s10,32(sp)
    5eda:	6de2                	ld	s11,24(sp)
    5edc:	6109                	addi	sp,sp,128
    5ede:	8082                	ret
...
void fprintf(int fd, const char *fmt, ...)
{
  ...
  vprintf(fd, fmt, ap);
    ...
    5f02:	e04080e7          	jalr	-508(ra) # 5d02 <vprintf>
}
...
void printf(const char *fmt, ...)
{
  ...
  vprintf(1, fmt, ap);
    ...
    5f38:	dce080e7          	jalr	-562(ra) # 5d02 <vprintf>
}
...
malloc(uint nbytes)
{
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    60a0:	b50080e7          	jalr	-1200(ra) # 5bec <sbrk>
  if (p == (char *)-1)
